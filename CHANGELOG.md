...
# 38.2.0
- Updating to OAS 2020-09-14_1.673.1
...
# 33.1.0
- Updating to OAS 2020-09-14_1.638.1
...
- Converts some integers that were incorrectly typed as `Double` to `Integer`. For more details, see the changelog notes for 2020-09-14_1.349.0.
