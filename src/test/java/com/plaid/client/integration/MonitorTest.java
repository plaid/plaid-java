...
public class MonitorTest extends AbstractIntegrationTest {
    ...
    public void testSuccess() throws Exception {
        ...
        watchlistScreeningIndividualUpdateRequest
          .setWatchlistScreeningId(watchlistScreeningIndividualCreateResponse.body().getId());
        watchlistScreeningIndividualUpdateRequest.setStatus(WatchlistScreeningStatusNullable.PENDING_REVIEW);
        ...
        watchlistScreeningIndividualListRequest.setStatus(WatchlistScreeningStatusNullable.CLEARED);
