...
public class AccountsBalanceGetTest extends AbstractItemIntegrationTest {
  ...
  public void testAccountsBalanceGetWithAccountId() throws Exception {
    ...
    AbstractItemIntegrationTest.assertAccount(accounts.get(0), "depository", "savings", 200d, 210d, null, "Plaid Saving", "1111", "Plaid Silver Standard 0.1% Interest Saving");
  }
