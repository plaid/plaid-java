...
public class ExtendedRecipientMetadata {
   ...
   * @return recipientId
  **/
  @ApiModelProperty(required = true, value = "The recipient's (application's) identifier")
   ...
   * @return clientName
  **/
  @ApiModelProperty(required = true, value = "The recipient's (application's) name, as displayed to your customers during the consent flow")
  ...
  **/
  ...
  @ApiModelProperty(value = "URL for the recipient's (application's) logo")
  ...
  **/
  @ApiModelProperty(required = true, value = "The recipient's (application's) legal entity name")
   ...
   * @return category
  **/
  @ApiModelProperty(required = true, value = "The category the recipient (application) falls under")
   ...
   * @return joinedDate
  **/
  @ApiModelProperty(example = "Thu Jul 15 00:00:00 UTC 2021", required = true, value = "The date the recipient (application) gained production access to Plaid")
  ...
  **/
  @ApiModelProperty(required = true, value = "The number of your customers connected to this recipient (application)")
