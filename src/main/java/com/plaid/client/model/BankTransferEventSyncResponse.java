 ...
 */
@ApiModel(description = "BankTransferEventSyncResponse defines the response schema for `/bank_transfer/event/sync`")
...
public class BankTransferEventSyncResponse {
  ...
  private List<BankTransferEvent> bankTransferEvents = new ArrayList<BankTransferEvent>();
