...
public class Numbers {
   ...
   * @return account
  **/
  @ApiModelProperty(required = true, value = "Will be used for the account number.")
   ...
   * @return achRouting
  **/
  @ApiModelProperty(required = true, value = "Must be a valid ACH routing number.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Must be a valid wire transfer routing number.")
  ...
  **/
  @ApiModelProperty(required = true, value = "EFT institution number. Must be specified alongside `eft_branch`.")
   ...
   * @return eftBranch
  **/
  @ApiModelProperty(required = true, value = "EFT branch number. Must be specified alongside `eft_institution`.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Bank identifier code (BIC). Must be specified alongside `international_iban`.")
  ...
  **/
  @ApiModelProperty(required = true, value = "International bank account number (IBAN). If no account number is specified via `account`, will also be used as the account number by default. Must be specified alongside `international_bic`.")
   ...
   * @return bacsSortCode
  **/
  @ApiModelProperty(required = true, value = "BACS sort code")
