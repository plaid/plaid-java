...
public class PaymentStatusUpdateWebhook {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(webhookType, webhookCode, paymentId, newPaymentStatus, oldPaymentStatus, originalReference, adjustedReference, originalStartDate, adjustedStartDate, timestamp, error, environment);
  }
