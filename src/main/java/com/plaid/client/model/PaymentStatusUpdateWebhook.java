...
public class PaymentStatusUpdateWebhook {
  ...
  **/
  ...
  @ApiModelProperty(value = "The original value of the reference when creating the payment.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The original value of the `start_date` provided during the creation of a standing order. If the payment is not a standing order, this field will be `null`.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The start date sent to the bank after adjusting for holidays or weekends.  Will be provided in ISO 8601 format (YYYY-MM-DD). If the start date did not require adjustment, or if the payment is not a standing order, this field will be `null`.")
  ...
  public PaymentStatusUpdateWebhook timestamp(String timestamp) {
   ...
   * @return timestamp
  **/
  @ApiModelProperty(required = true, value = "The timestamp of the update, in ISO 8601 format, e.g. `\"2017-09-14T14:42:19.350Z\"`")
