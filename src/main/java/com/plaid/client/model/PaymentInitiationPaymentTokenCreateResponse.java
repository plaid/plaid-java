...
public class PaymentInitiationPaymentTokenCreateResponse {
  ...
  private String paymentTokenExpirationTime;
  ...
  **/
  ...
  public PaymentInitiationPaymentTokenCreateResponse paymentTokenExpirationTime(String paymentTokenExpirationTime) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The date and time at which the token will expire, in ISO 8601 format. A `payment_token` expires after 15 minutes.")

  public String getPaymentTokenExpirationTime() {
    return paymentTokenExpirationTime;
  }


  public void setPaymentTokenExpirationTime(String paymentTokenExpirationTime) {
    this.paymentTokenExpirationTime = paymentTokenExpirationTime;
  }
