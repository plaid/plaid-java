...
import com.plaid.client.model.CashflowReportPaymentMeta;
...
public class CashflowReportTransaction {
  ...
  private CashflowReportPaymentMeta paymentMeta;
  ...
  public CashflowReportTransaction accountId(String accountId) {
  ...
  **/
  ...
  public CashflowReportTransaction amount(Double amount) {
  ...
  **/
  ...
  public CashflowReportTransaction isoCurrencyCode(String isoCurrencyCode) {
  ...
  **/
  ...
  public CashflowReportTransaction unofficialCurrencyCode(String unofficialCurrencyCode) {
  ...
  **/
  ...
  public CashflowReportTransaction checkNumber(String checkNumber) {
  ...
  **/
  ...
  public CashflowReportTransaction location(Location location) {
  ...
  **/
  ...
  public CashflowReportTransaction name(String name) {
  ...
  **/
  ...
  public CashflowReportTransaction merchantName(String merchantName) {
  ...
  **/
  ...
  public CashflowReportTransaction originalDescription(String originalDescription) {
  ...
  **/
  ...
  public CashflowReportTransaction paymentMeta(CashflowReportPaymentMeta paymentMeta) {
  ...
  **/
  ...
  public CashflowReportPaymentMeta getPaymentMeta() {
    return paymentMeta;
  }


  public void setPaymentMeta(CashflowReportPaymentMeta paymentMeta) {
    this.paymentMeta = paymentMeta;
  }


  public CashflowReportTransaction pending(Boolean pending) {
  ...
  **/
  ...
  public CashflowReportTransaction pendingTransactionId(String pendingTransactionId) {
  ...
  **/
  ...
  public CashflowReportTransaction accountOwner(String accountOwner) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "This field is not typically populated and only relevant when dealing with sub-accounts. A sub-account most commonly exists in cases where a single account is linked to multiple cards, each with its own card number and card holder name; each card will be considered a sub-account. If the account does have sub-accounts, this field will typically be some combination of the sub-account owner's name and/or the sub-account mask. The format of this field is not standardized and will vary based on institution.")
  ...
  public CashflowReportTransaction transactionId(String transactionId) {
  ...
  **/
  ...
  public CashflowReportTransaction logoUrl(String logoUrl) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The URL of a logo associated with this transaction, if available. The logo will always be a 100×100 pixel PNG file.")
  ...
  public CashflowReportTransaction website(String website) {
  ...
  **/
  ...
  public CashflowReportTransaction authorizedDate(LocalDate authorizedDate) {
  ...
  **/
  ...
  public CashflowReportTransaction authorizedDatetime(OffsetDateTime authorizedDatetime) {
  ...
  **/
  ...
  public CashflowReportTransaction datetime(OffsetDateTime datetime) {
  ...
  **/
  ...
  public CashflowReportTransaction paymentChannel(PaymentChannel paymentChannel) {
  ...
  **/
  ...
  public CashflowReportTransaction personalFinanceCategory(PersonalFinanceCategory personalFinanceCategory) {
  ...
  **/
  ...
  public CashflowReportTransaction businessFinanceCategory(BusinessFinanceCategory businessFinanceCategory) {
  ...
  **/
  ...
  public CashflowReportTransaction creditCategory(CreditCategory creditCategory) {
  ...
  **/
  ...
  public CashflowReportTransaction transactionCode(TransactionCode transactionCode) {
  ...
  **/
  ...
  public CashflowReportTransaction personalFinanceCategoryIconUrl(String personalFinanceCategoryIconUrl) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The URL of an icon associated with the primary personal finance category. The icon will always be a 100×100 pixel PNG file.")
  ...
  public CashflowReportTransaction counterparties(List<TransactionCounterparty> counterparties) {
    
    this.counterparties = counterparties;
    return this;
  }

  public CashflowReportTransaction addCounterpartiesItem(TransactionCounterparty counterpartiesItem) {
  ...
  **/
  ...
  public CashflowReportTransaction merchantEntityId(String merchantEntityId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CashflowReportTransaction cashflowReportTransaction = (CashflowReportTransaction) o;
    return Objects.equals(this.accountId, cashflowReportTransaction.accountId) &&
        Objects.equals(this.amount, cashflowReportTransaction.amount) &&
        Objects.equals(this.isoCurrencyCode, cashflowReportTransaction.isoCurrencyCode) &&
        Objects.equals(this.unofficialCurrencyCode, cashflowReportTransaction.unofficialCurrencyCode) &&
        Objects.equals(this.checkNumber, cashflowReportTransaction.checkNumber) &&
        Objects.equals(this.date, cashflowReportTransaction.date) &&
        Objects.equals(this.location, cashflowReportTransaction.location) &&
        Objects.equals(this.name, cashflowReportTransaction.name) &&
        Objects.equals(this.merchantName, cashflowReportTransaction.merchantName) &&
        Objects.equals(this.originalDescription, cashflowReportTransaction.originalDescription) &&
        Objects.equals(this.paymentMeta, cashflowReportTransaction.paymentMeta) &&
        Objects.equals(this.pending, cashflowReportTransaction.pending) &&
        Objects.equals(this.pendingTransactionId, cashflowReportTransaction.pendingTransactionId) &&
        Objects.equals(this.accountOwner, cashflowReportTransaction.accountOwner) &&
        Objects.equals(this.transactionId, cashflowReportTransaction.transactionId) &&
        Objects.equals(this.logoUrl, cashflowReportTransaction.logoUrl) &&
        Objects.equals(this.website, cashflowReportTransaction.website) &&
        Objects.equals(this.authorizedDate, cashflowReportTransaction.authorizedDate) &&
        Objects.equals(this.authorizedDatetime, cashflowReportTransaction.authorizedDatetime) &&
        Objects.equals(this.datetime, cashflowReportTransaction.datetime) &&
        Objects.equals(this.paymentChannel, cashflowReportTransaction.paymentChannel) &&
        Objects.equals(this.personalFinanceCategory, cashflowReportTransaction.personalFinanceCategory) &&
        Objects.equals(this.businessFinanceCategory, cashflowReportTransaction.businessFinanceCategory) &&
        Objects.equals(this.creditCategory, cashflowReportTransaction.creditCategory) &&
        Objects.equals(this.transactionCode, cashflowReportTransaction.transactionCode) &&
        Objects.equals(this.personalFinanceCategoryIconUrl, cashflowReportTransaction.personalFinanceCategoryIconUrl) &&
        Objects.equals(this.counterparties, cashflowReportTransaction.counterparties) &&
        Objects.equals(this.merchantEntityId, cashflowReportTransaction.merchantEntityId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, amount, isoCurrencyCode, unofficialCurrencyCode, checkNumber, date, location, name, merchantName, originalDescription, paymentMeta, pending, pendingTransactionId, accountOwner, transactionId, logoUrl, website, authorizedDate, authorizedDatetime, datetime, paymentChannel, personalFinanceCategory, businessFinanceCategory, creditCategory, transactionCode, personalFinanceCategoryIconUrl, counterparties, merchantEntityId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CashflowReportTransaction {\n");
