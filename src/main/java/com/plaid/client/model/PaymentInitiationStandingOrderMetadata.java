...
public class PaymentInitiationStandingOrderMetadata {
  ...
  private List<PaymentScheduleInterval> validStandingOrderIntervals = null;
  ...
  **/
  ...
  @ApiModelProperty(value = "Indicates whether the institution supports closed-ended standing orders by providing an end date.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This is only applicable to `MONTHLY` standing orders. Indicates whether the institution supports negative integers (-1 to -5) for setting up a `MONTHLY` standing order relative to the end of the month.")
  ...
  public PaymentInitiationStandingOrderMetadata addValidStandingOrderIntervalsItem(PaymentScheduleInterval validStandingOrderIntervalsItem) {
    if (this.validStandingOrderIntervals == null) {
      this.validStandingOrderIntervals = new ArrayList<>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of the valid standing order intervals supported by the institution.")
