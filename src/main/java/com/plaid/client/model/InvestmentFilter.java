...
public class InvestmentFilter {
  ...
  public InvestmentFilter accountSubtypes(List<AccountSubtype> accountSubtypes) {
    
    this.accountSubtypes = accountSubtypes;
    return this;
  }

  public InvestmentFilter addAccountSubtypesItem(AccountSubtype accountSubtypesItem) {
  ...
  **/
  @ApiModelProperty(required = true, value = "An array of account subtypes to display in Link. If not specified, all account subtypes will be shown. For a full list of valid types and subtypes, see the [Account schema](https://plaid.com/docs/api/accounts#accounts-schema). ")
