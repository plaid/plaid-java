...
public class EmailAddressMatchScore {
  ...
  **/
  ...
  @ApiModelProperty(value = "Match score for normalized email. 100 is a perfect match and 0 is a no match. If the email is missing from either the API or financial institution, this is null.")
