...
public class LinkTokenCreateRequestIncomeVerificationPayrollIncome {
  ...
  **/
  ...
  public LinkTokenCreateRequestIncomeVerificationPayrollIncome addParsingConfigItem(IncomeVerificationDocParsingConfig parsingConfigItem) {
   ...
   /**
   * The types of analysis to enable for document uploads. If none are specified, then docs will undergo OCR parsing only.
   * @return parsingConfig
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The types of analysis to enable for document uploads. If none are specified, then docs will undergo OCR parsing only.")
