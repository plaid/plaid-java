...
public class LinkDeliveryGetResponse {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An array of access tokens associated with the Link Delivery session.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An array of `item_id`s associated with the Link Delivery session.")
