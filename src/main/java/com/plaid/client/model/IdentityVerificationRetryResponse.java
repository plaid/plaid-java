...
public class IdentityVerificationRetryResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, clientUserId, createdAt, completedAt, previousAttemptId, shareableUrl, template, user, status, steps, documentaryVerification, kycCheck, riskCheck, watchlistScreeningId, redactedAt, requestId);
  }
