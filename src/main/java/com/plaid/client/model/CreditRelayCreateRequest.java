...
public class CreditRelayCreateRequest {
  ...
  **/
  ...
  public CreditRelayCreateRequest reportTokens(List<ReportToken> reportTokens) {
    
    this.reportTokens = reportTokens;
    return this;
  }

  public CreditRelayCreateRequest addReportTokensItem(ReportToken reportTokensItem) {
   ...
   * @return reportTokens
  **/
  @ApiModelProperty(required = true, value = "List of report tokens, with at most one token of each report type. Currently only Asset Report token is supported.")
