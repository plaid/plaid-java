...
public class TransactionsGetRequestOptions {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If Transactions has not already been added to the Item, this option controls the maximum number of days of transaction history Plaid will request from the financial institution. If Transactions has already been added to the Item, this field will have no effect.")
