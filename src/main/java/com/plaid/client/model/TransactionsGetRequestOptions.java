...
public class TransactionsGetRequestOptions {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Please use [`include_personal_finance_category`](https://plaid.com/docs/api/products/#transactions-get-request-options-include-personal-finance-category) instead.")
