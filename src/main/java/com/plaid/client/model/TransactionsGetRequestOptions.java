...
public class TransactionsGetRequestOptions {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Include counterparties and extran merchant fields in the transaction. This field is disabled by default. If you need this information in addition to the parsed data provided, contact your Plaid Account Manager.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountIds, count, offset, includeOriginalDescription, includePersonalFinanceCategoryBeta, includePersonalFinanceCategory, includeLogoAndCounterpartyBeta);
  }
