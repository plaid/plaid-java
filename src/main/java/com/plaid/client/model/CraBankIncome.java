...
public class CraBankIncome {
  ...
  **/
  ...
  @ApiModelProperty(value = "The unique identifier associated with the report.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The time when the report was generated.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of days requested by the customer for the report.")
