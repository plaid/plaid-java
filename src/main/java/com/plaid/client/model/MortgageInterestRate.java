...
public class MortgageInterestRate {
  ...
  **/
  ...
  @ApiModelProperty(value = "Percentage value (interest rate of current mortgage, not APR) of interest payable on a loan.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of interest charged (fixed or variable).")
