...
public class NameMatchScore {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "first or last name completely matched, likely a family member")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "nickname matched, example Jennifer and Jenn.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "Is `true` if the name on either of the names that was matched for the score contained strings indicative of a business name, such as \"CORP\", \"LLC\", \"INC\", or \"LTD\". A `true` result generally indicates that an account's name is a business name. However, a `false` result does not mean the account name is not a business name, as some businesses do not use these strings in the names used for their financial institution accounts.")
