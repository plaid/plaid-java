...
public class TransferAuthorizationDevice {
  ...
  **/
  ...
  @ApiModelProperty(value = "The IP address of the device being used to initiate the authorization. Required for Guarantee or when the end-user is present at authorization create time.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The user agent of the device being used to initiate the authorization. Required for Guarantee or when the end-user is present at authorization create time.")
