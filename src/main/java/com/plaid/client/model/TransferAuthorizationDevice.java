...
public class TransferAuthorizationDevice {
  ...
  **/
  ...
  @ApiModelProperty(value = "The IP address of the device being used to initiate the authorization. Required for Guarantee.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The user agent of the device being used to initiate the authorization. Required for Guarantee.")
