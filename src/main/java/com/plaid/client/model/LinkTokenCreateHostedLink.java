...
public class LinkTokenCreateHostedLink {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "How many seconds the link will be valid for. Must be positive. Cannot be longer than 21 days. ")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deliveryMethod, completionRedirectUri, urlLifetimeSeconds);
  }
