...
public class OverrideAccounts {
  ...
  public static final String SERIALIZED_NAME_HAS_NULL_AVAILABLE_BALANCE = "has_null_available_balance";
  @SerializedName(SERIALIZED_NAME_HAS_NULL_AVAILABLE_BALANCE)
  private Boolean hasNullAvailableBalance;
  ...
  **/
  @ApiModelProperty(required = true, value = "If provided, the account will always have this amount as its available balance, regardless of current balance or changes in transactions over time. Cannot be set together with `has_null_available_balance`. ")
  ...
  public OverrideAccounts hasNullAvailableBalance(Boolean hasNullAvailableBalance) {
   ...
   * @return hasNullAvailableBalance
  **/
  @ApiModelProperty(required = true, value = "If set to `true`, the account will always have null as its available balance, regardless of current balance or changes in transactions over time. Cannot be set together with `force_available_balance`. ")

  public Boolean getHasNullAvailableBalance() {
    return hasNullAvailableBalance;
  }


  public void setHasNullAvailableBalance(Boolean hasNullAvailableBalance) {
    this.hasNullAvailableBalance = hasNullAvailableBalance;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, overrideAccounts.type) &&
        ...
        Objects.equals(this.hasNullAvailableBalance, overrideAccounts.hasNullAvailableBalance) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, subtype, startingBalance, forceAvailableBalance, hasNullAvailableBalance, currency, meta, numbers, transactions, holdings, investmentTransactions, identity, liability, inflowModel, income);
  }
