...
public class OverrideAccounts {
  ...
  public OverrideAccounts type(AccountType type) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, subtype, startingBalance, forceAvailableBalance, currency, meta, numbers, transactions, identity, liability, inflowModel);
  }
