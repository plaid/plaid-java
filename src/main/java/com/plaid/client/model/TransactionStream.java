...
public class TransactionStream {
  ...
  **/
   ...
   * @return category
  **/
  @ApiModelProperty(required = true, value = "A hierarchical array of the categories to which this transaction belongs. See [Categories](https://plaid.com/docs/api/products/transactions/#categoriesget).")
   ...
   * @return categoryId
  **/
  @ApiModelProperty(required = true, value = "The ID of the category to which this transaction belongs. See [Categories](https://plaid.com/docs/api/products/transactions/#categoriesget).")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, streamId, category, categoryId, description, merchantName, firstDate, lastDate, frequency, transactionIds, averageAmount, lastAmount, isActive, status, personalFinanceCategory);
  }
