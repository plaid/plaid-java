...
public class TransactionStream {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, streamId, categoryId, category, description, merchantName, firstDate, lastDate, frequency, transactionIds, averageAmount, lastAmount, isActive, status);
  }
