...
public class TransactionStream {
  ...
  public static final String SERIALIZED_NAME_LAST_USER_MODIFIED_DATE = "last_user_modified_date";
  @SerializedName(SERIALIZED_NAME_LAST_USER_MODIFIED_DATE)
  private LocalDate lastUserModifiedDate;
  ...
  **/
  ...
  public TransactionStream lastUserModifiedDate(LocalDate lastUserModifiedDate) {
    
    this.lastUserModifiedDate = lastUserModifiedDate;
    return this;
  }

   /**
   * The date of the most recent user modification. This will only be set if &#x60;is_user_modified&#x60; is &#x60;true&#x60;.
   * @return lastUserModifiedDate
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date of the most recent user modification. This will only be set if `is_user_modified` is `true`.")

  public LocalDate getLastUserModifiedDate() {
    return lastUserModifiedDate;
  }


  public void setLastUserModifiedDate(LocalDate lastUserModifiedDate) {
    this.lastUserModifiedDate = lastUserModifiedDate;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, transactionStream.accountId) &&
        ...
        Objects.equals(this.lastUserModifiedDate, transactionStream.lastUserModifiedDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, streamId, category, categoryId, description, merchantName, firstDate, lastDate, frequency, transactionIds, averageAmount, lastAmount, isActive, status, personalFinanceCategory, isUserModified, lastUserModifiedDate);
  }
  ...
  public String toString() {
    ...
    sb.append("    lastUserModifiedDate: ").append(toIndentedString(lastUserModifiedDate)).append("\n");
    sb.append("}");
    return sb.toString();
  }
