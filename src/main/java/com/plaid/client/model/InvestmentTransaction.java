...
public class InvestmentTransaction {
  ...
  public static final String SERIALIZED_NAME_TRANSACTION_DATETIME = "transaction_datetime";
  @SerializedName(SERIALIZED_NAME_TRANSACTION_DATETIME)
  ...
  **/
  ...
  public InvestmentTransaction transactionDatetime(OffsetDateTime transactionDatetime) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Timestamp in [ISO 8601](https://wikipedia.org/wiki/ISO_8601) format (`YYYY-MM-DDTHH:mm:ssZ`) representing when the order was initiated. This field is returned for select financial institutions and reflects the value provided by the institution. When the institution only provides a date without time-of-day information, this field will reflect the date that the order was initiated with a time component that defaults to `T00:00:00Z`. This does not indicate that the order was initiated at midnight UTC.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.investmentTransactionId, investmentTransaction.investmentTransactionId) &&
        ...
        Objects.equals(this.transactionDatetime, investmentTransaction.transactionDatetime) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(investmentTransactionId, cancelTransactionId, accountId, securityId, date, transactionDatetime, name, quantity, amount, price, fees, type, subtype, isoCurrencyCode, unofficialCurrencyCode);
  }
