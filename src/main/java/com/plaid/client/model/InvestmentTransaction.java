...
public class InvestmentTransaction {
  ...
  **/
   ...
   * @return subtype
  **/
  @ApiModelProperty(required = true, value = "For descriptions of possible transaction subtypes, see [Investment transaction subtypes schema](https://plaid.com/docs/api/accounts/#investment-transaction-subtypes-schema).")
