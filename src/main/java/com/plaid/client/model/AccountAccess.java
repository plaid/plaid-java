...
public class AccountAccess {
  ...
  private AccountProductAccessNullable accountProductAccess = null;
  ...
  **/
  ...
  @ApiModelProperty(value = "Allow the application to see this account (and associated details, including balance) in the list of accounts. If relevant to the partner and unset, defaults to `true`.")
