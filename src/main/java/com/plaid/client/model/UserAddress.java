...
public class UserAddress {
  ...
  **/
  ...
  @ApiModelProperty(example = "123 Main St.", value = "The primary street portion of an address. If the user has submitted their address, this field will always be filled.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Pawnee", value = "City from the end user's address")
