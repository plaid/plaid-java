 ...
 */
@ApiModel(description = "Home address for user supplied to `/identity_verification/create`")
...
public class UserAddress {
  ...
  **/
   ...
   * @return postalCode
  **/
  @ApiModelProperty(example = "46001", required = true, value = "The postal code for the associated address. Between 2 and 10 alphanumeric characters.")
