...
public class UserAddress {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Pawnee", value = "City from the address. A string with at least one non-whitespace alphabetical character, with a max length of 100 characters.")
