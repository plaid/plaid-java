...
public class Meta {
  ...
  **/
   ...
   * @return mask
  **/
  @ApiModelProperty(required = true, value = "The account's mask. Should be a string of 2-4 alphanumeric characters. This allows you to model a mask which does not match the account number (such as with a virtual account number).")
