...
public class Meta {
  ...
  **/
  ...
  @ApiModelProperty(value = "The annual percentage yield (APY) to report on the account, expressed as a percentage (e.g. `4.25` means 4.25%). Applies to interest-bearing depository accounts; if omitted, the account reports no APY.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, meta.name) &&
        ...
        Objects.equals(this.apy, meta.apy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, officialName, limit, mask, apy);
  }
