...
public class BetaEwaReportV1GetResponse {
  ...
  public static final String SERIALIZED_NAME_EWA_ATTRIBUTES = "ewa_attributes";
  @SerializedName(SERIALIZED_NAME_EWA_ATTRIBUTES)
  private Map<String, Double> ewaAttributes = null;
  ...
  **/
  ...
  public BetaEwaReportV1GetResponse ewaAttributes(Map<String, Double> ewaAttributes) {
    
    this.ewaAttributes = ewaAttributes;
    return this;
  }

  public BetaEwaReportV1GetResponse putEwaAttributesItem(String key, Double ewaAttributesItem) {
    if (this.ewaAttributes == null) {
      this.ewaAttributes = new HashMap<>();
    }
    this.ewaAttributes.put(key, ewaAttributesItem);
    return this;
  }
   ...
   * @return ewaAttributes
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A set of attributes providing context about the factors that contributed to the EWA scores. Each key is the attribute name and the value is its numeric score, or null if the attribute could not be computed.")

  public Map<String, Double> getEwaAttributes() {
    return ewaAttributes;
  }


  public void setEwaAttributes(Map<String, Double> ewaAttributes) {
    this.ewaAttributes = ewaAttributes;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.requestId, betaEwaReportV1GetResponse.requestId) &&
        ...
        Objects.equals(this.ewaAttributes, betaEwaReportV1GetResponse.ewaAttributes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(requestId, ewaReportId, generationTime, ewaScores, ewaAttributes);
  }
