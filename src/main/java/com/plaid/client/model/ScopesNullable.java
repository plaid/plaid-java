...
public class ScopesNullable {
  ...
  public ScopesNullable productAccess(Object productAccess) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The product access being requested. Used to or disallow product access across all accounts. If unset, defaults to all products allowed.")

  public Object getProductAccess() {
    return productAccess;
  }


  public void setProductAccess(Object productAccess) {
    this.productAccess = productAccess;
  }
