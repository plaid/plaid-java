 ...
 */
@ApiModel(description = "List of individual watchlist screenings")
...
public class WatchlistScreeningList {
  ...
  public WatchlistScreeningList watchlistScreenings(List<WatchlistScreeningIndividual> watchlistScreenings) {
    
    this.watchlistScreenings = watchlistScreenings;
    return this;
  }

  public WatchlistScreeningList addWatchlistScreeningsItem(WatchlistScreeningIndividual watchlistScreeningsItem) {
  ...
  **/
  ...
  public WatchlistScreeningList requestId(String requestId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WatchlistScreeningList watchlistScreeningList = (WatchlistScreeningList) o;
    return Objects.equals(this.watchlistScreenings, watchlistScreeningList.watchlistScreenings) &&
        Objects.equals(this.requestId, watchlistScreeningList.requestId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(watchlistScreenings, requestId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WatchlistScreeningList {\n");
