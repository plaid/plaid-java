...
public class IdentityVerificationStepUpdatedWebhook {
   ...
   * @return webhookType
  **/
  @ApiModelProperty(required = true, value = "`IDENTITY_VERIFCATION`")
  ...
  **/
  ...
  public IdentityVerificationStepUpdatedWebhook identityVerificationId(Object identityVerificationId) {
