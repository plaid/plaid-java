...
public class CreateEntityWatchlistScreeningReviewRequest {
  ...
  public CreateEntityWatchlistScreeningReviewRequest confirmedHits(List<String> confirmedHits) {
    
    this.confirmedHits = confirmedHits;
    return this;
  }

  public CreateEntityWatchlistScreeningReviewRequest addConfirmedHitsItem(String confirmedHitsItem) {
  ...
  **/
  ...
  public CreateEntityWatchlistScreeningReviewRequest dismissedHits(List<String> dismissedHits) {
    
    this.dismissedHits = dismissedHits;
    return this;
  }

  public CreateEntityWatchlistScreeningReviewRequest addDismissedHitsItem(String dismissedHitsItem) {
  ...
  **/
  ...
  public CreateEntityWatchlistScreeningReviewRequest comment(String comment) {
  ...
  **/
  ...
  public CreateEntityWatchlistScreeningReviewRequest clientId(String clientId) {
  ...
  **/
  ...
  public CreateEntityWatchlistScreeningReviewRequest secret(String secret) {
  ...
  **/
  ...
  public CreateEntityWatchlistScreeningReviewRequest entityWatchlistScreeningId(String entityWatchlistScreeningId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CreateEntityWatchlistScreeningReviewRequest createEntityWatchlistScreeningReviewRequest = (CreateEntityWatchlistScreeningReviewRequest) o;
    return Objects.equals(this.confirmedHits, createEntityWatchlistScreeningReviewRequest.confirmedHits) &&
        Objects.equals(this.dismissedHits, createEntityWatchlistScreeningReviewRequest.dismissedHits) &&
        Objects.equals(this.comment, createEntityWatchlistScreeningReviewRequest.comment) &&
        Objects.equals(this.clientId, createEntityWatchlistScreeningReviewRequest.clientId) &&
        Objects.equals(this.secret, createEntityWatchlistScreeningReviewRequest.secret) &&
        Objects.equals(this.entityWatchlistScreeningId, createEntityWatchlistScreeningReviewRequest.entityWatchlistScreeningId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateEntityWatchlistScreeningReviewRequest {\n");
