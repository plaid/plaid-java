...
public class AuthGetNumbers {
  ...
  public AuthGetNumbers addAchItem(NumbersACH achItem) {
    if (this.ach == null) {
      this.ach = new ArrayList<NumbersACH>();
    }
  ...
  **/
  ...
  @ApiModelProperty(value = "An array of ACH numbers identifying accounts.")
  ...
  public AuthGetNumbers addEftItem(NumbersEFT eftItem) {
    if (this.eft == null) {
      this.eft = new ArrayList<NumbersEFT>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An array of EFT numbers identifying accounts.")
  ...
  public AuthGetNumbers addInternationalItem(NumbersInternational internationalItem) {
    if (this.international == null) {
      this.international = new ArrayList<NumbersInternational>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An array of IBAN numbers identifying accounts.")
  ...
  public AuthGetNumbers addBacsItem(NumbersBACS bacsItem) {
    if (this.bacs == null) {
      this.bacs = new ArrayList<NumbersBACS>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An array of BACS numbers identifying accounts.")
