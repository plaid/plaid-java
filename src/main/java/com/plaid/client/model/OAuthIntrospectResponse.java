...
public class OAuthIntrospectResponse {
   ...
   * @return active
  **/
  @ApiModelProperty(required = true, value = "Boolean indicator of whether or not the presented token is currently active. A true value indicates that the token has been issued, has not been revoked, and is within the time window of validitity")
