...
public class LinkSessionResults {
  ...
  private List<LinkSessionCraItemAddResult> craItemAddResults = null;
  ...
  **/
  ...
  public LinkSessionResults addCraItemAddResultsItem(LinkSessionCraItemAddResult craItemAddResultsItem) {
    if (this.craItemAddResults == null) {
      this.craItemAddResults = new ArrayList<>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The set of Plaid Check Item adds for the Link session.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(itemAddResults, craItemAddResults, bankIncomeResults, payrollIncomeResults, documentIncomeResults);
  }
