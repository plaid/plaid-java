...
public class LinkSessionResults {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(itemAddResults, craItemAddResults, bankIncomeResults, payrollIncomeResults, documentIncomeResults, craDocumentUploadResults, protectResults);
  }
