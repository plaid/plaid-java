...
public class StandaloneAccountType {
   ...
   * @return depository
  **/
  @ApiModelProperty(required = true, value = "An account type holding cash, in which funds are deposited. Supported products for `depository` accounts are: Auth, Balance, Transactions, Identity, Payment Initiation, and Assets.")
  ...
  **/
   ...
   * @return investment
  **/
  @ApiModelProperty(required = true, value = "An investment account. Supported products for `investment` accounts are: Balance and Investments.")
