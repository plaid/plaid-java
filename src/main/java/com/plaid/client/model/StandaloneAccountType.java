...
public class StandaloneAccountType {
  ...
  **/
   ...
   * @return loan
  **/
  @ApiModelProperty(required = true, value = "A loan type account. Supported products for `loan` accounts are: Balance, Liabilities (`student` and `mortgage` subtypes only), Identity.")
   ...
   * @return investment
  **/
  @ApiModelProperty(required = true, value = "An investment account. Supported products for `investment` accounts are: Balance, Assets, Investments, and Investment Transactions. In API versions 2018-05-22 and earlier, this type is called `brokerage`.")
   ...
   * @return other
  **/
  @ApiModelProperty(required = true, value = "Other or unknown account type. Supported products for `other` accounts are: Balance, Identity.")
