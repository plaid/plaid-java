...
public class LinkTokenCreateRequestTransfer {
  ...
  **/
  ...
  public LinkTokenCreateRequestTransfer paymentProfileId(String paymentProfileId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The `payment_profile_id` returned by the `/payment_profile/create` endpoint.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.intentId, linkTokenCreateRequestTransfer.intentId) &&
        Objects.equals(this.paymentProfileId, linkTokenCreateRequestTransfer.paymentProfileId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(intentId, paymentProfileId);
  }
