...
public class ProtectIncidentEvent {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An access token associated with the Item related to this incident.")
  ...
  public ProtectIncidentEvent itemId(String itemId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An `item_id` associated with the Item related to this incident. To identify an Item when creating a report, provide `access_token`.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.protectEventId, protectIncidentEvent.protectEventId) &&
        ...
        Objects.equals(this.itemId, protectIncidentEvent.itemId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(protectEventId, linkSessionId, idvSessionId, signalClientTransactionId, internalReference, time, amount, accessToken, itemId);
  }
