...
public class CraBankIncomeSummary {
  ...
  public static final String SERIALIZED_NAME_FORCASTED_AVERAGE_MONTHLY_INCOME = "forcasted_average_monthly_income";
  @SerializedName(SERIALIZED_NAME_FORCASTED_AVERAGE_MONTHLY_INCOME)
  private List<CreditAmountWithCurrency> forcastedAverageMonthlyIncome = null;
  ...
  **/
  ...
  public CraBankIncomeSummary forcastedAverageMonthlyIncome(List<CreditAmountWithCurrency> forcastedAverageMonthlyIncome) {
    
    this.forcastedAverageMonthlyIncome = forcastedAverageMonthlyIncome;
    return this;
  }

  public CraBankIncomeSummary addForcastedAverageMonthlyIncomeItem(CreditAmountWithCurrency forcastedAverageMonthlyIncomeItem) {
    if (this.forcastedAverageMonthlyIncome == null) {
      this.forcastedAverageMonthlyIncome = new ArrayList<>();
    }
    this.forcastedAverageMonthlyIncome.add(forcastedAverageMonthlyIncomeItem);
    return this;
  }

   /**
   * The predicted average monthly income amount for the income source(s).
   * @return forcastedAverageMonthlyIncome
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The predicted average monthly income amount for the income source(s).")

  public List<CreditAmountWithCurrency> getForcastedAverageMonthlyIncome() {
    return forcastedAverageMonthlyIncome;
  }


  public void setForcastedAverageMonthlyIncome(List<CreditAmountWithCurrency> forcastedAverageMonthlyIncome) {
    this.forcastedAverageMonthlyIncome = forcastedAverageMonthlyIncome;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalAmounts, craBankIncomeSummary.totalAmounts) &&
        ...
        Objects.equals(this.forcastedAverageMonthlyIncome, craBankIncomeSummary.forcastedAverageMonthlyIncome) &&
        Objects.equals(this.historicalSummary, craBankIncomeSummary.historicalSummary);
  }

  @Override
  public int hashCode() {
    return Objects.hash(totalAmounts, startDate, endDate, incomeSourcesCount, incomeCategoriesCount, incomeTransactionsCount, historicalAverageMonthlyGrossIncome, historicalAverageMonthlyIncome, forcastedAverageMonthlyIncome, historicalSummary);
  }
  ...
  public String toString() {
    ...
    sb.append("    forcastedAverageMonthlyIncome: ").append(toIndentedString(forcastedAverageMonthlyIncome)).append("\n");
