...
public class LinkDeliveryGetRequest {
  ...
  **/
  @ApiModelProperty(required = true, value = "The ID for the Hosted Link session from a previous invocation of `/link_delivery/create`.")
  ...
  public boolean equals(Object o) {
    ...
    LinkDeliveryGetRequest linkDeliveryGetRequest = (LinkDeliveryGetRequest) o;
    return Objects.equals(this.clientId, linkDeliveryGetRequest.clientId) &&
        Objects.equals(this.secret, linkDeliveryGetRequest.secret) &&
        Objects.equals(this.linkDeliverySessionId, linkDeliveryGetRequest.linkDeliverySessionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, linkDeliverySessionId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LinkDeliveryGetRequest {\n");
