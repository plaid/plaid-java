...
public class UserIDNumber {
   ...
   * @return value
  **/
  @ApiModelProperty(example = "123456789", required = true, value = "Value of the identity document typed in by the user. Alpha-numeric, with all formatting characters stripped. For specific format requirements by ID type, see [Input Validation Rules](https://plaid.com/docs/identity-verification/hybrid-input-validation/#id-numbers).")
