...
public class Application {
  ...
  **/
  ...
  @ApiModelProperty(example = "Wed Jan 01 00:00:00 UTC 2020", value = "The date this application was linked in [ISO 8601](https://wikipedia.org/wiki/ISO_8601) (YYYY-MM-DD) format in UTC.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(applicationId, name, createdAt, joinDate, logoUrl, applicationUrl, reasonForAccess, useCase, companyLegalName, city, region, postalCode, countryCode);
  }
