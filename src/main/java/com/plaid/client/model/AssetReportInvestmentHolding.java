...
import com.plaid.client.model.HoldingTaxLot;
...
public class AssetReportInvestmentHolding {
  ...
  private List<HoldingTaxLot> taxLots = null;
  ...
  **/
  ...
  public AssetReportInvestmentHolding taxLots(List<HoldingTaxLot> taxLots) {
    
    this.taxLots = taxLots;
    return this;
  }

  public AssetReportInvestmentHolding addTaxLotsItem(HoldingTaxLot taxLotsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Per-lot acquisition data for this holding. This field is absent when lot-level data is not available for the holding — either the institution does not provide it, or the report was generated before lot-level data was supported. Refresh the report if you expect lots.")

  public List<HoldingTaxLot> getTaxLots() {
    return taxLots;
  }


  public void setTaxLots(List<HoldingTaxLot> taxLots) {
    this.taxLots = taxLots;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, assetReportInvestmentHolding.accountId) &&
        ...
        Objects.equals(this.taxLots, assetReportInvestmentHolding.taxLots);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, securityId, tickerSymbol, institutionPrice, institutionPriceAsOf, institutionValue, costBasis, quantity, isoCurrencyCode, unofficialCurrencyCode, taxLots);
  }
