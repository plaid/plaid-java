...
public class PaymentInitiationRecipientGetResponse {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "The International Bank Account Number (IBAN) for the recipient.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(recipientId, name, address, iban, bacs, emiRecipientId, requestId);
  }
