...
public class TransferAuthorizationUserInRequest {
  ...
  **/
  ...
  @ApiModelProperty(value = "The user's phone number. In order to qualify for a guaranteed transfer, at least one of `phone_number` or `email_address` must be provided.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The user's email address. In order to qualify for a guaranteed transfer, at least one of `phone_number` or `email_address` must be provided.")
