...
public class PaymentInitiationConsentCreateRequest {
  ...
  **/
  ...
  public PaymentInitiationConsentCreateRequest userId(String userId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The `user_id` of the end user the payment consent is for, as returned by [`/user/create`](https://plaid.com/docs/api/users/#usercreate). The user must have a `name` and either an email address or a phone number. Payments created from this consent inherit this `user_id`. Required for new integrations.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientId, paymentInitiationConsentCreateRequest.clientId) &&
        ...
        Objects.equals(this.userId, paymentInitiationConsentCreateRequest.userId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, recipientId, userId, reference, scopes, type, constraints, options, payerDetails);
  }
