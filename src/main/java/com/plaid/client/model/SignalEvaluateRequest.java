...
public class SignalEvaluateRequest {
  ...
  **/
   ...
   * @return accountId
  **/
  @ApiModelProperty(required = true, value = "The Plaid `account_id` of the account whose verification status is to be modified. The `account_id` is returned in the `/accounts/get` endpoint as well as the [`onSuccess`](/docs/link/ios/#link-ios-onsuccess-linkSuccess-metadata-accounts-id) callback metadata.  This will return an [`INVALID_ACCOUNT_ID`](/docs/errors/invalid-input/#invalid_account_id) error if the account has been removed at the bank or if the `account_id` is no longer valid.")
