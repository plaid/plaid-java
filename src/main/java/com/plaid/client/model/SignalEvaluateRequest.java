...
public class SignalEvaluateRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The key of the risk profile to use for this transaction. You can configure a risk profile using the Signal dashboard located within the Plaid Dashboard. If not provided, no risk profile will be used. This feature is currently in closed beta; to request access, contact your account manager.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, accessToken, accountId, clientTransactionId, amount, userPresent, clientUserId, isRecurring, defaultPaymentMethod, user, device, riskProfileKey);
  }
