...
public class SignalEvaluateRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Use `true` if the ACH transaction is a part of recurring schedule (for example, a monthly repayment); `false` otherwise ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The key of the ruleset to use for evaluating this transaction. You can configure a ruleset using the Signal dashboard located within the Plaid Dashboard. If not provided, no ruleset will be used.")
