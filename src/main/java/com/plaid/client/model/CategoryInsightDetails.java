...
public class CategoryInsightDetails {
  ...
  private List<Counterparty> topCounterparties = new ArrayList<>();
  ...
  **/
  ...
  public CategoryInsightDetails topCounterparties(List<Counterparty> topCounterparties) {
    
    this.topCounterparties = topCounterparties;
    return this;
  }

  public CategoryInsightDetails addTopCounterpartiesItem(Counterparty topCounterpartiesItem) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The most common counterparties associated with this category sorted by outflow.")

  public List<Counterparty> getTopCounterparties() {
    return topCounterparties;
  }


  public void setTopCounterparties(List<Counterparty> topCounterparties) {
    this.topCounterparties = topCounterparties;
  }
