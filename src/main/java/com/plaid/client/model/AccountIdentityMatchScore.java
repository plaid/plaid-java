...
public class AccountIdentityMatchScore {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, balances, mask, name, officialName, type, subtype, verificationStatus, verificationInsights, persistentAccountId, legalName, phoneNumber, emailAddress, address);
  }
