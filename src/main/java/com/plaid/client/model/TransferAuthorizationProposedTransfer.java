...
public class TransferAuthorizationProposedTransfer {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(achClass, accountId, fundingAccountId, type, user, amount, network, originationAccountId, isoCurrencyCode, originatorClientId, creditFundsSource);
  }
