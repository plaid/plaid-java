...
public class TransferAuthorizationProposedTransfer {
  ...
  **/
  ...
  public TransferAuthorizationProposedTransfer description(String description) {
   ...
   * @return description
  **/
  @ApiModelProperty(required = true, value = "A description of the proposed transfer.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.achClass, transferAuthorizationProposedTransfer.achClass) &&
        ...
        Objects.equals(this.description, transferAuthorizationProposedTransfer.description) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(achClass, accountId, type, user, amount, isoCurrencyCode, description, network, originationAccountId);
  }
