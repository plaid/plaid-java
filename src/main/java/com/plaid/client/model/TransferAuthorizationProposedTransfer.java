...
public class TransferAuthorizationProposedTransfer {
  ...
  **/
  ...
  public TransferAuthorizationProposedTransfer requestedAmount(String requestedAmount) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The amount originally requested by the client when creating the authorization (decimal string with two digits of precision e.g. \"800.00\"). This may differ from `amount`, the amount Plaid proposes to transfer, when only a partial amount is offered as part of an Adaptive Guarantee.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.achClass, transferAuthorizationProposedTransfer.achClass) &&
        ...
        Objects.equals(this.requestedAmount, transferAuthorizationProposedTransfer.requestedAmount) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(achClass, accountId, fundingAccountId, ledgerId, type, user, amount, requestedAmount, network, wireDetails, originationAccountId, isoCurrencyCode, originatorClientId, creditFundsSource);
  }
