...
public class LinkTokenCreateRequestStatements {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The end date for statements, in [ISO 8601](https://wikipedia.org/wiki/ISO_8601) “YYYY-MM-DD” format, e.g. \"2020-10-30\". If no value is provided, this will default to the current date.")
