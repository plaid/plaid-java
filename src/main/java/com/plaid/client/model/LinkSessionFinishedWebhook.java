...
public class LinkSessionFinishedWebhook {
  ...
  **/
   ...
   * @return linkToken
  **/
  @ApiModelProperty(required = true, value = "The `link_token` used to create the Link session.")
  ...
  **/
  ...
  public LinkSessionFinishedWebhook userId(String userId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.webhookType, linkSessionFinishedWebhook.webhookType) &&
        ...
        Objects.equals(this.userId, linkSessionFinishedWebhook.userId) &&
        Objects.equals(this.environment, linkSessionFinishedWebhook.environment);
  }

  @Override
  public int hashCode() {
    return Objects.hash(webhookType, webhookCode, status, linkSessionId, linkToken, publicToken, publicTokens, userId, environment);
  }
