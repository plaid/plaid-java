...
public class AssetReportItem {
  ...
  **/
  ...
  public AssetReportItem dateLastUpdated(String dateLastUpdated) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The date and time when this Item’s data was last retrieved from the financial institution, in ISO 8601 format.")
