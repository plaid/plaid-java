...
public class CraBankIncomeItem {
  ...
  private List<CraBankIncomeAccount> accounts = null;
  ...
  **/
  ...
  public CraBankIncomeItem accounts(List<CraBankIncomeAccount> accounts) {
    
    this.accounts = accounts;
    return this;
  }

  public CraBankIncomeItem addAccountsItem(CraBankIncomeAccount accountsItem) {
  ...
  **/
  ...
  public List<CraBankIncomeAccount> getAccounts() {
    return accounts;
  }


  public void setAccounts(List<CraBankIncomeAccount> accounts) {
    this.accounts = accounts;
  }
  ...
  **/
  @ApiModelProperty(required = true, value = "This is a V1 (II1) field. For the V2 (II2) equivalent, use the `accounts` field. The Item's accounts that have bank income data.")
  ...
  **/
  @ApiModelProperty(required = true, value = "This is a V1 (II1) field. For the V2 (II2) equivalent, use the report-level `income_streams` field. The income sources for this Item. Each entry in the array is a single income source.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.itemId, craBankIncomeItem.itemId) &&
        Objects.equals(this.accounts, craBankIncomeItem.accounts) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(itemId, accounts, bankIncomeAccounts, bankIncomeSources, lastUpdatedTime, institutionId, institutionName);
  }
