...
public class PaymentInitiationAddress {
  ...
  **/
  ...
  @ApiModelProperty(value = "An array of length 1-2 representing the street address where the recipient is located. Maximum of 70 characters.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The city where the recipient is located. Maximum of 35 characters.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The postal code where the recipient is located. Maximum of 16 characters.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ISO 3166-1 alpha-2 country code where the recipient is located.")
