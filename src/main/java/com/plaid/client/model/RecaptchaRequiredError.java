...
public class RecaptchaRequiredError {
  ...
  **/
  ...
  public RecaptchaRequiredError httpCode(Integer httpCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Your user will be prompted to solve a Google reCAPTCHA challenge in the Link Recaptcha pane. If they solve the challenge successfully, the user's request is resubmitted and they are directed to the next Item creation step.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Plaid's fraud system detects abusive traffic and considers a variety of parameters throughout Item creation requests. When a request is considered risky or possibly fraudulent, Link presents a reCAPTCHA for the user to solve.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Link will automatically guide your user through reCAPTCHA verification. As a general rule, we recommend instrumenting basic fraud monitoring to detect and protect your website from spam and abuse.  If your user cannot verify their session, please submit a support ticket with the following identifiers: `link_session_id` or `request_id`")
