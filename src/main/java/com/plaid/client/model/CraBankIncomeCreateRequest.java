...
public class CraBankIncomeCreateRequest {
  ...
  public CraBankIncomeCreateRequest clientId(String clientId) {
  ...
  **/
  ...
  public CraBankIncomeCreateRequest secret(String secret) {
  ...
  **/
  ...
  public CraBankIncomeCreateRequest userToken(String userToken) {
  ...
  **/
  ...
  public CraBankIncomeCreateRequest webhook(String webhook) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The destination URL to which webhooks will be sent ")
  ...
  public CraBankIncomeCreateRequest daysRequested(Integer daysRequested) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of days of data to request")
  ...
  public CraBankIncomeCreateRequest consumerReportPermissiblePurpose(ConsumerReportPermissiblePurpose consumerReportPermissiblePurpose) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CraBankIncomeCreateRequest craBankIncomeCreateRequest = (CraBankIncomeCreateRequest) o;
    return Objects.equals(this.clientId, craBankIncomeCreateRequest.clientId) &&
        Objects.equals(this.secret, craBankIncomeCreateRequest.secret) &&
        Objects.equals(this.userToken, craBankIncomeCreateRequest.userToken) &&
        Objects.equals(this.webhook, craBankIncomeCreateRequest.webhook) &&
        Objects.equals(this.daysRequested, craBankIncomeCreateRequest.daysRequested) &&
        Objects.equals(this.consumerReportPermissiblePurpose, craBankIncomeCreateRequest.consumerReportPermissiblePurpose);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, userToken, webhook, daysRequested, consumerReportPermissiblePurpose);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CraBankIncomeCreateRequest {\n");
