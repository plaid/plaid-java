...
public class SignalDecisionReportRequest {
  ...
  **/
  ...
  public SignalDecisionReportRequest submittedAt(OffsetDateTime submittedAt) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date the ACH debit was submitted to the bank for processing (in ISO 8601 format: `YYYY-MM-DDTHH:mm:ssZ`). This field should correspond to the attempt initiated after the `/signal/schedule` call.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientId, signalDecisionReportRequest.clientId) &&
        ...
        Objects.equals(this.submittedAt, signalDecisionReportRequest.submittedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, clientTransactionId, initiated, daysFundsOnHold, decisionOutcome, paymentMethod, amountInstantlyAvailable, submittedAt);
  }
