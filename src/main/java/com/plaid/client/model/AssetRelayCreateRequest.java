 ...
 */
@ApiModel(description = "AssetRelayCreateRequest defines the request schema for `/asset_report/relay/create`")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-02-28T21:01:48.207Z[GMT]")
public class AssetRelayCreateRequest {
  ...
  public AssetRelayCreateRequest clientId(String clientId) {
  ...
  **/
  ...
  public AssetRelayCreateRequest secret(String secret) {
  ...
  **/
  ...
  public AssetRelayCreateRequest assetReportToken(String assetReportToken) {
  ...
  **/
  ...
  public AssetRelayCreateRequest secondaryClientId(String secondaryClientId) {
  ...
  **/
  ...
  public AssetRelayCreateRequest webhook(String webhook) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AssetRelayCreateRequest assetRelayCreateRequest = (AssetRelayCreateRequest) o;
    return Objects.equals(this.clientId, assetRelayCreateRequest.clientId) &&
        Objects.equals(this.secret, assetRelayCreateRequest.secret) &&
        Objects.equals(this.assetReportToken, assetRelayCreateRequest.assetReportToken) &&
        Objects.equals(this.secondaryClientId, assetRelayCreateRequest.secondaryClientId) &&
        Objects.equals(this.webhook, assetRelayCreateRequest.webhook);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssetRelayCreateRequest {\n");
