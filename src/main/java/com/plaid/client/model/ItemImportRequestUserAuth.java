...
public class ItemImportRequestUserAuth {
   ...
   * @return userId
  **/
  @ApiModelProperty(required = true, value = "Your persistent, unique identifier for the customer.")
  ...
  **/
  ...
  @ApiModelProperty(value = "Authorization token used by the legacy Plaid Exchange integration; not required for Permissions Manager callers.")
