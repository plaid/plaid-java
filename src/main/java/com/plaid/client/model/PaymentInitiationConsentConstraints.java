...
public class PaymentInitiationConsentConstraints {
  ...
  private PaymentConsentMaxPaymentAmount maxPaymentAmount = null;
  ...
  private List<PaymentConsentPeriodicAmount> periodicAmounts = null;
  ...
  **/
  ...
  public PaymentInitiationConsentConstraints addPeriodicAmountsItem(PaymentConsentPeriodicAmount periodicAmountsItem) {
    if (this.periodicAmounts == null) {
      this.periodicAmounts = new ArrayList<>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of amount limitations per period of time.")
