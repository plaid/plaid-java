...
import com.plaid.client.model.CreditI20;
...
public class PayrollIncomeObject {
  ...
  public static final String SERIALIZED_NAME_I20S = "i20s";
  @SerializedName(SERIALIZED_NAME_I20S)
  private List<CreditI20> i20s = new ArrayList<>();
  ...
  **/
  ...
  public PayrollIncomeObject i20s(List<CreditI20> i20s) {
    
    this.i20s = i20s;
    return this;
  }

  public PayrollIncomeObject addI20sItem(CreditI20 i20sItem) {
    this.i20s.add(i20sItem);
    return this;
  }
   ...
   * @return i20s
  **/
  @ApiModelProperty(required = true, value = "Array of Form I-20 US immigration student documents.")

  public List<CreditI20> getI20s() {
    return i20s;
  }


  public void setI20s(List<CreditI20> i20s) {
    this.i20s = i20s;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, payrollIncomeObject.accountId) &&
        ...
        Objects.equals(this.i20s, payrollIncomeObject.i20s);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, payStubs, w2s, form1099s, i20s);
  }
