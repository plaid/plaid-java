...
public class HealthIncident {
  ...
  public HealthIncident startDate(String startDate) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The start date of the incident, in ISO 8601 format, e.g. `\"2020-10-30T15:26:48Z\"`.")
  ...
  public HealthIncident endDate(String endDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The end date of the incident, in ISO 8601 format, e.g. `\"2020-10-30T15:26:48Z\"`.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The title of the incident")
  ...
  public HealthIncident addIncidentUpdatesItem(IncidentUpdate incidentUpdatesItem) {
    if (this.incidentUpdates == null) {
      this.incidentUpdates = new ArrayList<>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Updates on the health incident.")
