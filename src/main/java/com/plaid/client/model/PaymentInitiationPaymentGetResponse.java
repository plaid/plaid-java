...
public class PaymentInitiationPaymentGetResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(paymentId, amount, status, recipientId, reference, adjustedReference, lastStatusUpdate, schedule, refundDetails, bacs, iban, initiatedRefunds, walletId, requestId);
  }
