...
public class PaymentInitiationPaymentGetResponse {
  ...
  **/
  ...
  public PaymentInitiationPaymentGetResponse schedule(ExternalPaymentSchedule schedule) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(paymentId, requestId, amount, status, recipientId, reference, lastStatusUpdate, schedule, adjustedReference);
  }
