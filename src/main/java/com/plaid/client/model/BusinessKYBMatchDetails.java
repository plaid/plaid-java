...
import com.plaid.client.model.ProviderBusinessName;
...
public class BusinessKYBMatchDetails {
  ...
  private List<ProviderBusinessName> names = new ArrayList<>();
  ...
  public BusinessKYBMatchDetails names(List<ProviderBusinessName> names) {
    
    this.names = names;
    return this;
  }

  public BusinessKYBMatchDetails addNamesItem(ProviderBusinessName namesItem) {
   ...
   * @return names
  **/
  @ApiModelProperty(required = true, value = "Names associated with the business.")

  public List<ProviderBusinessName> getNames() {
    return names;
  }


  public void setNames(List<ProviderBusinessName> names) {
    this.names = names;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.names, businessKYBMatchDetails.names) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(names, entityType, addresses, phoneNumbers, emailAddresses, websites, formationDate);
  }
