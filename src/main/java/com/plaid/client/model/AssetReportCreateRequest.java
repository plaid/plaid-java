...
public class AssetReportCreateRequest {
  ...
  **/
  ...
  public AssetReportCreateRequest userToken(String userToken) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The user token associated with the User for which to create an asset report for. All items associated with the User will be included in the report.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientId, assetReportCreateRequest.clientId) &&
        ...
        Objects.equals(this.userToken, assetReportCreateRequest.userToken) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, accessTokens, userToken, daysRequested, options, reportType);
  }
