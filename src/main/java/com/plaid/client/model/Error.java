...
public class Error {
  ...
  **/
   ...
   * @return requestId
  **/
  @ApiModelProperty(required = true, value = "A unique identifying the request, to be used for troubleshooting purposes. This field will be omitted in errors provided by webhooks.")
