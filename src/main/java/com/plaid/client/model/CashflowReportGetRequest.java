 ...
 */
@ApiModel(description = "CashflowReportGetRequest defines the reqest schema for `/cashflow_report/get`")
...
public class CashflowReportGetRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, accessToken, secret, daysRequested, count, cursor);
  }
