...
public class AssetsProductReadyWebhook {
  ...
  **/
  ...
  @ApiModelProperty(value = "The report type specifying whether the asset report is a `full` or `fast` report.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(webhookType, webhookCode, assetReportId, reportType);
  }
