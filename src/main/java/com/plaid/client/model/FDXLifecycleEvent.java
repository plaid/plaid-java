...
public class FDXLifecycleEvent {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2021-07-15T14:46:41.375Z", value = "ISO 8601 date-time in format 'YYYY-MM-DDThh:mm:ss.nnn[Z|[+|-]hh:mm]' according to [IETF RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)")
