...
public class BaseReportAttributes {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(nsfOverdraftTransactionsCount, isPrimaryAccount, primaryAccountScore, totalInflowAmount, totalInflowAmount30d, totalInflowAmount60d, totalInflowAmount90d, totalOutflowAmount, totalOutflowAmount30d, totalOutflowAmount60d, totalOutflowAmount90d);
  }
