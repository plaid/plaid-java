...
import com.plaid.client.model.ConnectedApplicationStatus;
...
public class ConnectedApplication {
  ...
  private ConnectedApplicationStatus status;
  ...
  **/
  ...
  public ConnectedApplication status(ConnectedApplicationStatus status) {
  ...
  **/
  ...
  public ConnectedApplicationStatus getStatus() {
    return status;
  }


  public void setStatus(ConnectedApplicationStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.applicationId, connectedApplication.applicationId) &&
        ...
        Objects.equals(this.status, connectedApplication.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(applicationId, name, logo, logoUrl, applicationUrl, reasonForAccess, createdAt, joinDate, productDataTypes, scopes, requestedScopes, status);
  }
