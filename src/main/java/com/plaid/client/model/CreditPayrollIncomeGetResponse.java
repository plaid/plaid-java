...
public class CreditPayrollIncomeGetResponse {
  public static final String SERIALIZED_NAME_PAYROLL_INCOME_ID = "payroll_income_id";
  @SerializedName(SERIALIZED_NAME_PAYROLL_INCOME_ID)
  private String payrollIncomeId;
  ...
  public CreditPayrollIncomeGetResponse payrollIncomeId(String payrollIncomeId) {
    
    this.payrollIncomeId = payrollIncomeId;
    return this;
  }

   /**
   * The unique identifier associated with the payroll income response.
   * @return payrollIncomeId
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique identifier associated with the payroll income response.")

  public String getPayrollIncomeId() {
    return payrollIncomeId;
  }


  public void setPayrollIncomeId(String payrollIncomeId) {
    this.payrollIncomeId = payrollIncomeId;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.payrollIncomeId, creditPayrollIncomeGetResponse.payrollIncomeId) &&
        Objects.equals(this.items, creditPayrollIncomeGetResponse.items) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(payrollIncomeId, items, error, requestId);
  }
  ...
  public String toString() {
    ...
    sb.append("    payrollIncomeId: ").append(toIndentedString(payrollIncomeId)).append("\n");
