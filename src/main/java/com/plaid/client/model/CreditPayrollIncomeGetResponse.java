...
public class CreditPayrollIncomeGetResponse {
  ...
  public static final String SERIALIZED_NAME_INCOME_REPORT_TOKEN = "income_report_token";
  @SerializedName(SERIALIZED_NAME_INCOME_REPORT_TOKEN)
  private String incomeReportToken;
  ...
  **/
  ...
  public CreditPayrollIncomeGetResponse incomeReportToken(String incomeReportToken) {
   ...
   * @return incomeReportToken
  **/
  @ApiModelProperty(required = true, value = "A token to reference what payroll data was returned from this endpoint")

  public String getIncomeReportToken() {
    return incomeReportToken;
  }


  public void setIncomeReportToken(String incomeReportToken) {
    this.incomeReportToken = incomeReportToken;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, creditPayrollIncomeGetResponse.items) &&
        ...
        Objects.equals(this.incomeReportToken, creditPayrollIncomeGetResponse.incomeReportToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(items, error, requestId, incomeReportToken);
  }
  ...
  public String toString() {
    ...
    sb.append("    incomeReportToken: ").append(toIndentedString(incomeReportToken)).append("\n");
    sb.append("}");
    return sb.toString();
  }
