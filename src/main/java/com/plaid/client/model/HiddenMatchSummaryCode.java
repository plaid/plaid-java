 ...
 */
@JsonAdapter(HiddenMatchSummaryCode.Adapter.class)
public enum HiddenMatchSummaryCode {
  ...
  HiddenMatchSummaryCode(String value) {
    this.value = value;
  }
  ...
  public static HiddenMatchSummaryCode fromValue(String value) {
    for (HiddenMatchSummaryCode b : HiddenMatchSummaryCode.values()) {
      if (b.value.equals(value)) {
        return b;
      }
    }
    
    return HiddenMatchSummaryCode.ENUM_UNKNOWN;
  }

  public static class Adapter extends TypeAdapter<HiddenMatchSummaryCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final HiddenMatchSummaryCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public HiddenMatchSummaryCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return HiddenMatchSummaryCode.fromValue(value);
    }
  }
}
