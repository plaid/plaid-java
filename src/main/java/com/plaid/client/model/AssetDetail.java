...
public class AssetDetail {
  ...
  **/
  @ApiModelProperty(required = true, value = "Asset Account Current Balance.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "Additional Asset Description. Some examples are Investment Tax-Deferred, Loan, 401K, 403B, Checking, Money Market, Credit Card, ROTH, 529, Biller, ROLLOVER, CD, Savings, Investment Taxable, IRA, Mortgage, Line Of Credit.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The number of days requested from the Financial Institution. Example: When looking for 3 months of data from the FI, pass in 90 days.")
