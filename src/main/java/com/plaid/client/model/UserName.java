 ...
 */
@ApiModel(description = "The first and last name provided by the user. If the user has not submitted their name, this field will be null. Otherwise, both fields are guaranteed to be filled.")
...
public class UserName {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.givenName, userName.givenName) &&
