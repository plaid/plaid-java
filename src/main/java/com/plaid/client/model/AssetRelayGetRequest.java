 ...
 */
@ApiModel(description = "AssetRelayGetRequest defines the request schema for `/asset_report/relay/get`")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-02-28T21:01:48.207Z[GMT]")
public class AssetRelayGetRequest {
  ...
  public AssetRelayGetRequest clientId(String clientId) {
  ...
  **/
  ...
  public AssetRelayGetRequest secret(String secret) {
  ...
  **/
  ...
  public AssetRelayGetRequest assetRelayToken(String assetRelayToken) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AssetRelayGetRequest assetRelayGetRequest = (AssetRelayGetRequest) o;
    return Objects.equals(this.clientId, assetRelayGetRequest.clientId) &&
        Objects.equals(this.secret, assetRelayGetRequest.secret) &&
        Objects.equals(this.assetRelayToken, assetRelayGetRequest.assetRelayToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssetRelayGetRequest {\n");
