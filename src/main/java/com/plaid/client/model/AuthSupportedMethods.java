...
public class AuthSupportedMethods {
  ...
  **/
  @ApiModelProperty(required = true, value = "Indicates if automated micro-deposits are supported.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Indicates if instant micro-deposits are supported.")
