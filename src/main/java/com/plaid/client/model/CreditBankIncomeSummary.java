...
public class CreditBankIncomeSummary {
  ...
  **/
  ...
  @ApiModelProperty(value = "Total amount of earnings across all the income sources in the end user's Items for the days requested by the client.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(totalAmount, isoCurrencyCode, unofficialCurrencyCode, startDate, endDate, incomeSourcesCount, incomeCategoriesCount, incomeTransactionsCount, historicalSummary);
  }
