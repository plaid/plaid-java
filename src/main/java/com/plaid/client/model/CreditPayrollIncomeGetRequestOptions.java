...
public class CreditPayrollIncomeGetRequestOptions {
  ...
  **/
  ...
  @ApiModelProperty(value = "An array of `item_id`s whose payroll information is returned. Each `item_id` should uniquely identify a payroll income item. If this field is not provided, all `item_id`s associated with the user will be returned in the response.")
