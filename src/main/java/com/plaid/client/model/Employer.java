...
public class Employer {
  ...
  **/
  ...
  public Employer address(NullableAddressData address) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A number from 0 to 1 indicating Plaid's level of confidence in the pairing between the employer and the institution (not yet implemented).")
