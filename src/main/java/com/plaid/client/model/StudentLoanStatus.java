...
public class StudentLoanStatus {
  ...
  public StudentLoanStatus endDate(String endDate) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The date until which the loan will be in its current status. Dates are returned in an ISO 8601 format (YYYY-MM-DD). ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The status type of the student loan")
