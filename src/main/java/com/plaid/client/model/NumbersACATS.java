...
public class NumbersACATS {
  ...
  **/
   ...
   * @return dtcNumbers
  **/
  @ApiModelProperty(required = true, value = "Identifiers for the clearinghouses that are associated with the account in order of relevance. If this array is empty, call `/institutions/get_by_id` with the `item.institution_id` to get the DTC number.")
