...
public class TransferIntentGet {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "When `true`, the transfer requires a `GUARANTEED` decision by Plaid to proceed (Guaranteed ACH customers only).")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, created, status, transferId, failureReason, authorizationDecision, authorizationDecisionRationale, accountId, originationAccountId, amount, mode, achClass, user, description, metadata, isoCurrencyCode, requireGuarantee, guaranteeDecision, guaranteeDecisionRationale);
  }
