...
public class Enrichments {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(checkNumber, counterparties, legacyCategoryId, legacyCategory, location, logoUrl, merchantName, paymentChannel, personalFinanceCategory, personalFinanceCategoryIconUrl, website);
  }
