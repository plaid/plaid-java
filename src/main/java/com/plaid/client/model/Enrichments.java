...
public class Enrichments {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "The URL of a logo associated with this transaction, if available. The logo will always be a 100×100 pixel PNG file.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The URL of an icon associated with the primary personal finance category. The icon will always be a 100×100 pixel PNG file.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(checkNumber, counterparties, entityId, legacyCategoryId, legacyCategory, location, logoUrl, merchantName, paymentChannel, phoneNumber, personalFinanceCategory, personalFinanceCategoryIconUrl, website);
  }
