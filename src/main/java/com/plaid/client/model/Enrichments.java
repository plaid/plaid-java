...
public class Enrichments {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The website associated with this transaction.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A link to the logo associated with this transaction. The logo will always be 100x100 resolution.")
  ...
  **/
  @ApiModelProperty(required = true, value = "A link to the icon associated with the primary personal finance category. The logo will always be 100x100 resolution.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.merchantName, enrichments.merchantName) &&
        Objects.equals(this.website, enrichments.website) &&
        Objects.equals(this.logoUrl, enrichments.logoUrl) &&
        Objects.equals(this.checkNumber, enrichments.checkNumber) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(merchantName, website, logoUrl, checkNumber, paymentChannel, legacyCategoryId, legacyCategory, location, personalFinanceCategory, personalFinanceCategoryIconUrl, counterparties);
  }
