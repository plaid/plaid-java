...
public class Enrichments {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(checkNumber, counterparties, entityId, legacyCategoryId, legacyCategory, location, logoUrl, merchantName, paymentChannel, personalFinanceCategory, personalFinanceCategoryIconUrl, website);
  }
