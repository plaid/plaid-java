...
public class IncidentUpdate {
  ...
  **/
  ...
  public IncidentUpdate updatedDate(String updatedDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date when the update was published, in ISO 8601 format, e.g. `\"2020-10-30T15:26:48Z\"`.")
