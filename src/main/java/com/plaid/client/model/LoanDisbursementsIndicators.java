...
public class LoanDisbursementsIndicators {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Up to 3 top service providers that the user had the most transactions for in the given time window, in descending order of total spend.  If the user has not received money from any provider in the given time window, this list will be empty.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The percentage of the user's monthly inflows that was received on transactions that fall into the `LOAN_DISBURSEMENTS` credit category within the given time window, across all the accounts in the report. For example, a value of 100 indicates that 100% of the inflows were spent on transactions that fall into the `LOAN_DISBURSEMENTS` credit category. If there's no available income for the given time period, this field value will be `-1`.")
