...
public class BankTransferUser {
   ...
   * @return legalName
  **/
  @ApiModelProperty(required = true, value = "The account holder’s full legal name. If the transfer description is `ccd`, this should be the business name of the account holder.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The account holder's routing number. This field is only used for response data. Do not provide this field when making requests.")
