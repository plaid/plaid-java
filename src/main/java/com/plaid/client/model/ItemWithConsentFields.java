...
public class ItemWithConsentFields {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(itemId, institutionId, webhook, error, availableProducts, billedProducts, products, consentedProducts, consentExpirationTime, updateType, createdAt, consentedUseCases, consentedDataScopes);
  }
