...
public class SandboxTransferLedgerSimulateAvailableRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specify which ledger balance to simulate converting pending balance to available balance. If this field is left blank, this will default to the id of the default ledger balance.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Plaid's unique identifier for a test clock. If provided, only the pending balance that is due before the `virtual_time` on the test clock will be converted.")
