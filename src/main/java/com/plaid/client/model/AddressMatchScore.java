 ...
 */
@ApiModel(description = "Score found by matching address provided by the API with the address on the account at the financial institution. If the account contains multiple owners, the maximum match score is filled.")
...
public class AddressMatchScore {
  ...
  **/
  ...
  @ApiModelProperty(value = "Match score for address. 100 is a perfect match and 0 is a no match. If the address is missing from either the API or financial institution, this is empty.")
