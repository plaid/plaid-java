...
public class BankTransferEventListRequest {
  ...
  **/
  ...
  public BankTransferEventListRequest direction(String direction) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates the direction of the transfer: `outbound` for API-initiated transfers, or `inbound` for payments received by the FBO account.")
