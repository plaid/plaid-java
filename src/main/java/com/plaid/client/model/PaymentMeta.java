...
public class PaymentMeta {
  ...
  **/
  ...
  @ApiModelProperty(value = "The transaction reference number supplied by the financial institution.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ACH PPD ID for the payer.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "For transfers, the party that is receiving the transaction.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The party initiating a wire transfer. Will be `null` if the transaction is not a wire transfer.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "For transfers, the party that is paying the transaction.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of transfer, e.g. 'ACH'")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name of the payment processor")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The payer-supplied description of the transfer.")
