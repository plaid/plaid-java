...
public class DocumentRiskSignal {
  ...
  **/
  ...
  @ApiModelProperty(value = "The result from the risk signal check.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The field which the risk signal was computed for")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A flag used to quickly identify if the signal indicates that this field is authentic or fraudulent")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The expected value of the field, as seen on the document")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The derived value obtained in the risk signal calculation process for this field")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, field, hasFraudRisk, institutionMetadata, expectedValue, actualValue);
  }
