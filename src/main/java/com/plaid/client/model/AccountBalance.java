...
public class AccountBalance {
  ...
  **/
  ...
  public AccountBalance lastUpdatedDatetime(String lastUpdatedDatetime) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Timestamp in ISO-8601 format (`YYYY-MM-DDTHH:mm:ssZ`) indicating the last time that the balance for the given account has been updated.  This is currently only provided when the `min_last_updated_datetime` is passed when calling `/accounts/balance/get` for `ins_128026` (Capital One).")
