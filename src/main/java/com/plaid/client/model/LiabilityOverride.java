...
public class LiabilityOverride {
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "The type of the liability object, either `credit` or `student`.")
  ...
  **/
  ...
  public LiabilityOverride lastStatementBalance(Double lastStatementBalance) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Override the `last_statement_balance` field. Can only be set if `type` is `credit`.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Override the `minimum_payment_amount` field. Can only be set if `type` is `credit`.")
  ...
  **/
  ...
  public LiabilityOverride originationDate(String originationDate) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The date on which the loan was initially lent, in ISO 8601 (YYYY-MM-DD) format. Can only be set if `type` is `student`.")
  ...
  **/
  ...
  public LiabilityOverride expectedPayoffDate(String expectedPayoffDate) {
  ...
  **/
  ...
  public LiabilityOverride loanStatus(String loanStatus) {
   ...
   * @return loanStatus
  **/
  @ApiModelProperty(required = true, value = "Override the `loan_status` field. Can only be set if `type` is `student`.")
  ...
  **/
  ...
  public LiabilityOverride pslfStatus(String pslfStatus) {
   ...
   * @return pslfStatus
  **/
  @ApiModelProperty(required = true, value = "Override the `pslf_status` field. Can only be set if `type` is `student`.")

  public String getPslfStatus() {
    return pslfStatus;
  }


  public void setPslfStatus(String pslfStatus) {
    this.pslfStatus = pslfStatus;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, liabilityOverride.type) &&
        ...
        Objects.equals(this.lastStatementBalance, liabilityOverride.lastStatementBalance) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, purchaseApr, cashApr, balanceTransferApr, specialApr, lastPaymentAmount, lastStatementBalance, minimumPaymentAmount, isOverdue, originationDate, principal, nominalApr, interestCapitalizationGracePeriodMonths, repaymentModel, expectedPayoffDate, guarantor, isFederal, loanName, loanStatus, paymentReferenceNumber, pslfStatus, repaymentPlanDescription, repaymentPlanType, sequenceNumber, servicerAddress);
  }
