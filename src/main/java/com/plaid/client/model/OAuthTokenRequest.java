...
public class OAuthTokenRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "user-sandbox-b0e2c4ee-a763-4df5-bfe9-46a46bce993d", value = "Token representing the subject. The meaning depends on the `subject_token_type`.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(grantType, clientId, clientSecret, scope, refreshToken, resource, audience, subjectToken, subjectTokenType);
  }
