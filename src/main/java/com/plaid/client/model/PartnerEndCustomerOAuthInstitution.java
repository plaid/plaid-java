...
public class PartnerEndCustomerOAuthInstitution {
  ...
  private List<PlaidError> errors = null;
  ...
  **/
  ...
  public PartnerEndCustomerOAuthInstitution errors(List<PlaidError> errors) {
    
    this.errors = errors;
    return this;
  }

  public PartnerEndCustomerOAuthInstitution addErrorsItem(PlaidError errorsItem) {
    if (this.errors == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The errors encountered while registering the end customer's application with the institutions.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, partnerEndCustomerOAuthInstitution.name) &&
        ...
        Objects.equals(this.errors, partnerEndCustomerOAuthInstitution.errors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, institutionId, environments, productionEnablementDate, classicDisablementDate, errors);
  }
