...
public class BankTransfer {
  ...
  **/
  ...
  public BankTransfer created(String created) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A string containing the custom tag provided by the client in the create request. Will be null if not provided.")
