 ...
 */
@ApiModel(description = "ProcessorBankTransferCreateRequest defines the request schema for `/processor/bank_transfer/create`")
...
public class ProcessorBankTransferCreateRequest {
  ...
  **/
   ...
   * @return amount
  **/
  @ApiModelProperty(required = true, value = "The transfer amount (decimal string with two digits of precision e.g. \"10.00\").")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An arbitrary string provided by the client for storage with the bank transfer. Will be returned in all `BankTransfer` objects. May be up to 100 characters.")
