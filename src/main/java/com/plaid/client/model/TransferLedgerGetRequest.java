...
public class TransferLedgerGetRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specify which ledger balance to get. Customers can find a list of `ledger_id`s in the Accounts page of your Plaid Dashboard. If this field is left blank, this will default to the id of the default ledger balance.")
