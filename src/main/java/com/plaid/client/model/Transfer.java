...
import com.plaid.client.model.TransferExpectedSettlementScheduleItem;
...
public class Transfer {
  ...
  public static final String SERIALIZED_NAME_EXPECTED_SETTLEMENT_SCHEDULE = "expected_settlement_schedule";
  @SerializedName(SERIALIZED_NAME_EXPECTED_SETTLEMENT_SCHEDULE)
  private List<TransferExpectedSettlementScheduleItem> expectedSettlementSchedule = null;
  ...
  **/
  ...
  public Transfer settledAmount(String settledAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The accumulated amount that have been swept to date. This number does not reflect `return_swept` amount if the transfer is returned. Only applies to ACH debit transfers.")
  ...
  public Transfer expectedSettlementSchedule(List<TransferExpectedSettlementScheduleItem> expectedSettlementSchedule) {
    
    this.expectedSettlementSchedule = expectedSettlementSchedule;
    return this;
  }

  public Transfer addExpectedSettlementScheduleItem(TransferExpectedSettlementScheduleItem expectedSettlementScheduleItem) {
    if (this.expectedSettlementSchedule == null) {
      this.expectedSettlementSchedule = new ArrayList<>();
    }
    this.expectedSettlementSchedule.add(expectedSettlementScheduleItem);
    return this;
  }

   /**
   * The expected settlement schedule of this transfer, if posted. Only applies to ACH debit transfers.
   * @return expectedSettlementSchedule
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The expected settlement schedule of this transfer, if posted. Only applies to ACH debit transfers.")

  public List<TransferExpectedSettlementScheduleItem> getExpectedSettlementSchedule() {
    return expectedSettlementSchedule;
  }


  public void setExpectedSettlementSchedule(List<TransferExpectedSettlementScheduleItem> expectedSettlementSchedule) {
    this.expectedSettlementSchedule = expectedSettlementSchedule;
  }
  ...
  public String toString() {
    ...
    sb.append("    expectedSettlementSchedule: ").append(toIndentedString(expectedSettlementSchedule)).append("\n");
    sb.append("}");
    return sb.toString();
  }
