...
import com.plaid.client.model.TransferGuaranteeDetails;
...
public class Transfer {
  ...
  public static final String SERIALIZED_NAME_GUARANTEE_DETAILS = "guarantee_details";
  @SerializedName(SERIALIZED_NAME_GUARANTEE_DETAILS)
  private TransferGuaranteeDetails guaranteeDetails;
  ...
  **/
  ...
  public Transfer guaranteeDetails(TransferGuaranteeDetails guaranteeDetails) {
  ...
  **/
  ...
  public TransferGuaranteeDetails getGuaranteeDetails() {
    return guaranteeDetails;
  }


  public void setGuaranteeDetails(TransferGuaranteeDetails guaranteeDetails) {
    this.guaranteeDetails = guaranteeDetails;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "The date 61 business days from settlement date indicating the following ACH returns can no longer happen: R05, R07, R10, R11, R51, R33, R37, R38, R52, R53. This will be of the form YYYY-MM-DD.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, transfer.id) &&
        ...
        Objects.equals(this.guaranteeDetails, transfer.guaranteeDetails) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, authorizationId, achClass, accountId, fundingAccountId, ledgerId, type, user, amount, description, created, status, sweepStatus, network, wireDetails, cancellable, failureReason, metadata, originationAccountId, guaranteeDecision, guaranteeDecisionRationale, guaranteeDetails, isoCurrencyCode, standardReturnWindow, unauthorizedReturnWindow, expectedSettlementDate, expectedFundsAvailableDate, originatorClientId, refunds, recurringTransferId, expectedSweepSettlementSchedule, creditFundsSource, facilitatorFee, networkTraceId);
  }
