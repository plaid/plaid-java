...
public class Transfer {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The account ID that should be credited/debited for this transfer.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, achClass, accountId, type, user, amount, description, created, status, sweepStatus, network, cancellable, failureReason, metadata, originationAccountId, guaranteeDecision, guaranteeDecisionRationale, isoCurrencyCode, standardReturnWindow, unauthorizedReturnWindow, originatorClientId, refunds);
  }
