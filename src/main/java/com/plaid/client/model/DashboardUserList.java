 ...
 */
@ApiModel(description = "List of dashboard users")
...
public class DashboardUserList {
  ...
  public DashboardUserList dashboardUsers(List<DashboardUser> dashboardUsers) {
    
    this.dashboardUsers = dashboardUsers;
    return this;
  }

  public DashboardUserList addDashboardUsersItem(DashboardUser dashboardUsersItem) {
  ...
  **/
  ...
  public DashboardUserList requestId(String requestId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DashboardUserList dashboardUserList = (DashboardUserList) o;
    return Objects.equals(this.dashboardUsers, dashboardUserList.dashboardUsers) &&
        Objects.equals(this.requestId, dashboardUserList.requestId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dashboardUsers, requestId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DashboardUserList {\n");
