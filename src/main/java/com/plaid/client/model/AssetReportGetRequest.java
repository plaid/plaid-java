...
public class AssetReportGetRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "`true` if you would like to retrieve the Asset Report with Insights, `false` otherwise. This field defaults to `false` if omitted. [Contact Plaid Support](https://dashboard.plaid.com/support) to get access to this feature.")
