...
public class AssetReportGetRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "`true` to fetch \"fast\" version of asset report. Defaults to false if omitted.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, assetReportToken, includeInsights, fastReport, options);
  }
