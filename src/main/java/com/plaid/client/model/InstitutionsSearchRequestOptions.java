...
public class InstitutionsSearchRequestOptions {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "When true, return the institution's homepage URL, logo and primary brand color. Note that you may need to contact your Plaid Account Manager to be enabled to use this flag.")
