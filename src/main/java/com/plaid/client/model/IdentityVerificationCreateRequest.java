...
public class IdentityVerificationCreateRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "usr_dddAs9ewdcDQQQ", value = "A unique `user_id` generated by Plaid for the client-provided `client_user_id`. This field is currently in beta.")
