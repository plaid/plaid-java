...
public class UserAccountIdentity {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The user's email address.  Note: email is currently not returned for users, and is an upcoming addition that will be live in early 2025.")
