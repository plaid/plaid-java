...
public class HostedMMDVerificationWebhook {
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "The final status of the Same-Day Micro-deposits verification. Will always be `MANUALLY_VERIFIED` or `VERIFICATION_FAILED`.")
