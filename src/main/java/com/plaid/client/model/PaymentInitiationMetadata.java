...
public class PaymentInitiationMetadata {
  ...
  private Map<String, String> maximumPaymentAmount = null;
  ...
  **/
  ...
  @ApiModelProperty(value = "Indicates whether the institution supports payments from a different country.")
  ...
  public PaymentInitiationMetadata putMaximumPaymentAmountItem(String key, String maximumPaymentAmountItem) {
    if (this.maximumPaymentAmount == null) {
      this.maximumPaymentAmount = new HashMap<>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A mapping of currency to maximum payment amount (denominated in the smallest unit of currency) supported by the insitution.  Example: `{\"GBP\": \"10000\"}` ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the institution supports returning refund details when initiating a payment.")
