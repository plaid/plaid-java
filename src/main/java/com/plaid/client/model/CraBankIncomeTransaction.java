...
public class CraBankIncomeTransaction {
  ...
  **/
  ...
  @ApiModelProperty(value = "The merchant name or transaction description. This is a legacy field that is no longer maintained. For merchant name, use the `merchant_name` field; for description, use the `original_description` field.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.transactionId, craBankIncomeTransaction.transactionId) &&
        Objects.equals(this.amount, craBankIncomeTransaction.amount) &&
        Objects.equals(this.date, craBankIncomeTransaction.date) &&
        Objects.equals(this.name, craBankIncomeTransaction.name) &&
        Objects.equals(this.originalDescription, craBankIncomeTransaction.originalDescription) &&
        Objects.equals(this.pending, craBankIncomeTransaction.pending) &&
        Objects.equals(this.checkNumber, craBankIncomeTransaction.checkNumber) &&
        Objects.equals(this.isoCurrencyCode, craBankIncomeTransaction.isoCurrencyCode) &&
        Objects.equals(this.unofficialCurrencyCode, craBankIncomeTransaction.unofficialCurrencyCode) &&
        Objects.equals(this.bonusType, craBankIncomeTransaction.bonusType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(transactionId, amount, date, name, originalDescription, pending, checkNumber, isoCurrencyCode, unofficialCurrencyCode, bonusType);
  }
