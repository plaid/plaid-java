...
public class TransactionsRecurringGetResponse {
  ...
  private List<TransactionStream> inflowStreams = null;
  ...
  public TransactionsRecurringGetResponse addInflowStreamsItem(TransactionStream inflowStreamsItem) {
    if (this.inflowStreams == null) {
      this.inflowStreams = new ArrayList<>();
    }
  ...
  **/
  ...
  @ApiModelProperty(value = "An array of depository transaction streams.")
