...
public class AccountVerificationInsightsPreviousReturns {
  ...
  **/
  @ApiModelProperty(required = true, value = "Indicates whether Plaid's data sources include a known administrative ACH return for this account and routing number.")
