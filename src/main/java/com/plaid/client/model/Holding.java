...
public class Holding {
  ...
  **/
  ...
  public Holding taxLots(List<HoldingTaxLot> taxLots) {
    
    this.taxLots = taxLots;
    return this;
  }

  public Holding addTaxLotsItem(HoldingTaxLot taxLotsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Per-lot acquisition data for this holding. An empty array indicates the institution does not provide lot-level data.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, securityId, institutionPrice, institutionPriceAsOf, institutionPriceDatetime, institutionValue, costBasis, quantity, isoCurrencyCode, unofficialCurrencyCode, vestedQuantity, vestedValue, taxLots);
  }
