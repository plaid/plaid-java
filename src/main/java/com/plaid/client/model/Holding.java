...
public class Holding {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "The original total value or the purchase price per share of the holding. This field is an aggregate on a per holding basis and dependent on the information provided by the institution.")
