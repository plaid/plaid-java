...
public class TransferBalance {
  ...
  **/
  ...
  @ApiModelProperty(value = "The available balance, plus the amount of pending funds that are in processing (decimal string with two digits of precision e.g. \"10.00\").")
