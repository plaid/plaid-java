...
import com.plaid.client.model.WalletTransactionPayeeVerificationStatus;
...
public class WalletTransactionGetResponse {
  ...
  public static final String SERIALIZED_NAME_PAYEE_VERIFICATION_STATUS = "payee_verification_status";
  @SerializedName(SERIALIZED_NAME_PAYEE_VERIFICATION_STATUS)
  private WalletTransactionPayeeVerificationStatus payeeVerificationStatus;
  ...
  **/
   ...
   * @return walletId
  **/
  @ApiModelProperty(required = true, value = "The ID of the e-wallet that this transaction is associated with.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The date and time of the last time the `status` was updated, in ISO 8601 format")
  ...
  public WalletTransactionGetResponse payeeVerificationStatus(WalletTransactionPayeeVerificationStatus payeeVerificationStatus) {
    
    this.payeeVerificationStatus = payeeVerificationStatus;
    return this;
  }

   /**
   * Get payeeVerificationStatus
   * @return payeeVerificationStatus
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public WalletTransactionPayeeVerificationStatus getPayeeVerificationStatus() {
    return payeeVerificationStatus;
  }


  public void setPayeeVerificationStatus(WalletTransactionPayeeVerificationStatus payeeVerificationStatus) {
    this.payeeVerificationStatus = payeeVerificationStatus;
  }
  ...
  **/
  ...
  public WalletTransactionGetResponse error(PlaidError error) {
  ...
  **/
  ...
  public WalletTransactionGetResponse relatedTransactions(List<WalletTransactionRelation> relatedTransactions) {
    
    this.relatedTransactions = relatedTransactions;
    return this;
  }

  public WalletTransactionGetResponse addRelatedTransactionsItem(WalletTransactionRelation relatedTransactionsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.transactionId, walletTransactionGetResponse.transactionId) &&
        Objects.equals(this.walletId, walletTransactionGetResponse.walletId) &&
        ...
        Objects.equals(this.scheme, walletTransactionGetResponse.scheme) &&
        ...
        Objects.equals(this.payeeVerificationStatus, walletTransactionGetResponse.payeeVerificationStatus) &&
        ...
        Objects.equals(this.error, walletTransactionGetResponse.error) &&
        Objects.equals(this.relatedTransactions, walletTransactionGetResponse.relatedTransactions) &&
        Objects.equals(this.requestId, walletTransactionGetResponse.requestId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(transactionId, walletId, reference, type, scheme, amount, counterparty, status, createdAt, lastStatusUpdate, payeeVerificationStatus, paymentId, failureReason, error, relatedTransactions, requestId);
  }
