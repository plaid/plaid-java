...
public class BaseReportTransaction {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The merchant name or transaction description.  Note: This is a legacy field that is not actively maintained. Use `merchant_name` instead for the merchant name.")
  ...
  **/
  ...
  public BaseReportTransaction personalFinanceCategory(PersonalFinanceCategory personalFinanceCategory) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, baseReportTransaction.accountId) &&
        ...
        Objects.equals(this.personalFinanceCategory, baseReportTransaction.personalFinanceCategory);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, amount, isoCurrencyCode, unofficialCurrencyCode, name, originalDescription, creditCategory, checkNumber, date, dateTransacted, location, merchantName, pending, accountOwner, transactionId, transactionType, category, categoryId, personalFinanceCategory);
  }
