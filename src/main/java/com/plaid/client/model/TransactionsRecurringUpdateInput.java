...
public class TransactionsRecurringUpdateInput {
   ...
   * @return streamId
  **/
  @ApiModelProperty(required = true, value = "ID of the stream that all the transactions will be added into.")
  ...
  **/
  @ApiModelProperty(required = true, value = "IDs of all the transactions that will be added into the stream. If any transaction currently exists in another stream, it will be removed from the other stream.")
