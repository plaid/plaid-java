...
public class CreateIndividualWatchlistScreeningReviewRequest {
  ...
  public CreateIndividualWatchlistScreeningReviewRequest confirmedHits(List<String> confirmedHits) {
    
    this.confirmedHits = confirmedHits;
    return this;
  }

  public CreateIndividualWatchlistScreeningReviewRequest addConfirmedHitsItem(String confirmedHitsItem) {
  ...
  **/
  ...
  public CreateIndividualWatchlistScreeningReviewRequest dismissedHits(List<String> dismissedHits) {
    
    this.dismissedHits = dismissedHits;
    return this;
  }

  public CreateIndividualWatchlistScreeningReviewRequest addDismissedHitsItem(String dismissedHitsItem) {
  ...
  **/
  ...
  public CreateIndividualWatchlistScreeningReviewRequest comment(String comment) {
  ...
  **/
  ...
  public CreateIndividualWatchlistScreeningReviewRequest clientId(String clientId) {
  ...
  **/
  ...
  public CreateIndividualWatchlistScreeningReviewRequest secret(String secret) {
  ...
  **/
  ...
  public CreateIndividualWatchlistScreeningReviewRequest watchlistScreeningId(String watchlistScreeningId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CreateIndividualWatchlistScreeningReviewRequest createIndividualWatchlistScreeningReviewRequest = (CreateIndividualWatchlistScreeningReviewRequest) o;
    return Objects.equals(this.confirmedHits, createIndividualWatchlistScreeningReviewRequest.confirmedHits) &&
        Objects.equals(this.dismissedHits, createIndividualWatchlistScreeningReviewRequest.dismissedHits) &&
        Objects.equals(this.comment, createIndividualWatchlistScreeningReviewRequest.comment) &&
        Objects.equals(this.clientId, createIndividualWatchlistScreeningReviewRequest.clientId) &&
        Objects.equals(this.secret, createIndividualWatchlistScreeningReviewRequest.secret) &&
        Objects.equals(this.watchlistScreeningId, createIndividualWatchlistScreeningReviewRequest.watchlistScreeningId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateIndividualWatchlistScreeningReviewRequest {\n");
