...
public class TransferAuthorizationCreateRequest {
  ...
  **/
  ...
  public TransferAuthorizationCreateRequest description(String description) {
   ...
   * @return description
  **/
  @ApiModelProperty(required = true, value = "The authorization description. Maximum of 10 characters.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientId, transferAuthorizationCreateRequest.clientId) &&
        ...
        Objects.equals(this.description, transferAuthorizationCreateRequest.description) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, accessToken, accountId, type, network, amount, isoCurrencyCode, description, achClass, user, device, originationAccountId);
  }
