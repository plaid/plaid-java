...
public class TransferAuthorizationCreateRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specify which ledger balance should be used to fund the transfer. You can find a list of `ledger_id`s in the Accounts page of your Plaid Dashboard. If this field is left blank, this will default to the id of the default ledger balance.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If set to `false`, Plaid will not offer a `guarantee_decision` for this request (Guarantee customers only). This field is deprecated in favor of `guarantee`.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The key of the Ruleset for the transaction. If not provided, Signal will use the `default` ruleset.")
  ...
  public TransferAuthorizationCreateRequest customAttributes(Map<String, String> customAttributes) {
    
    this.customAttributes = customAttributes;
    return this;
  }

  public TransferAuthorizationCreateRequest putCustomAttributesItem(String key, String customAttributesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A free-form map of client-supplied risk-relevant context for this authorization. Plaid may use these attributes to inform future versions of our risk models.  The following limitations apply: Keys must match the regular expression `^[A-Za-z0-9_.-]{1,40}$` Values must be strings (no nested objects, arrays, numbers, or booleans allowed; stringify non-string values client-side) Maximum of 50 key/value pairs Maximum value length of 500 characters  Do not include personally identifiable information or other sensitive data. ")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientId, transferAuthorizationCreateRequest.clientId) &&
        ...
        Objects.equals(this.customAttributes, transferAuthorizationCreateRequest.customAttributes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, accessToken, accountId, fundingAccountId, ledgerId, paymentProfileToken, type, network, amount, achClass, wireDetails, user, device, originationAccountId, isoCurrencyCode, idempotencyKey, userPresent, withGuarantee, requestGuarantee, beaconSessionId, originatorClientId, creditFundsSource, testClockId, rulesetKey, customAttributes);
  }
