...
public class TransferAuthorizationCreateRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, accessToken, idempotencyKey, accountId, type, network, amount, achClass, user, device, originationAccountId, isoCurrencyCode, userPresent, withGuarantee, paymentProfileId);
  }
