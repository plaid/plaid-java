...
public class TransferAuthorizationCreateRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The Plaid `access_token` for the account that will be debited or credited.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Required for guaranteed ACH customers. If the end user is initiating the specific transfer themselves via an interactive UI, this should be `true`; for automatic recurring payments where the end user is not actually initiating each individual transfer, it should be `false`.")
  ...
  public TransferAuthorizationCreateRequest paymentProfileId(String paymentProfileId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Plaid’s unique identifier for a payment profile.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientId, transferAuthorizationCreateRequest.clientId) &&
        ...
        Objects.equals(this.paymentProfileId, transferAuthorizationCreateRequest.paymentProfileId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, accessToken, accountId, type, network, amount, achClass, user, device, originationAccountId, isoCurrencyCode, userPresent, paymentProfileId);
  }
