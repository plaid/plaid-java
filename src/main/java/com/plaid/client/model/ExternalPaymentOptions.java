...
public class ExternalPaymentOptions {
  ...
  public static final String SERIALIZED_NAME_SCHEME_AUTOMATIC_DOWNGRADE = "scheme_automatic_downgrade";
  @SerializedName(SERIALIZED_NAME_SCHEME_AUTOMATIC_DOWNGRADE)
  private Boolean schemeAutomaticDowngrade;
  ...
  **/
  ...
  public ExternalPaymentOptions schemeAutomaticDowngrade(Boolean schemeAutomaticDowngrade) {
    
    this.schemeAutomaticDowngrade = schemeAutomaticDowngrade;
    return this;
  }
   ...
   * @return schemeAutomaticDowngrade
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "When `true`, Plaid will attempt to automatically downgrade payment `scheme` (e.g. `SEPA_CREDIT_TRANSFER_INSTANT` to `SEPA_CREDIT_TRANSFER`) when the requested scheme is not supported by the bank.")

  public Boolean getSchemeAutomaticDowngrade() {
    return schemeAutomaticDowngrade;
  }


  public void setSchemeAutomaticDowngrade(Boolean schemeAutomaticDowngrade) {
    this.schemeAutomaticDowngrade = schemeAutomaticDowngrade;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.requestRefundDetails, externalPaymentOptions.requestRefundDetails) &&
        ...
        Objects.equals(this.schemeAutomaticDowngrade, externalPaymentOptions.schemeAutomaticDowngrade);
  }

  @Override
  public int hashCode() {
    return Objects.hash(requestRefundDetails, iban, bacs, walletId, scheme, schemeAutomaticDowngrade);
  }
  ...
  public String toString() {
    ...
    sb.append("    schemeAutomaticDowngrade: ").append(toIndentedString(schemeAutomaticDowngrade)).append("\n");
    sb.append("}");
    return sb.toString();
  }
