...
public class DetailedOriginator {
  ...
  **/
  ...
  @ApiModelProperty(value = "List of outstanding requirements that must be submitted before Plaid can approve the originator. Only populated when `transfer_diligence_status` is `more_information_required`.")
