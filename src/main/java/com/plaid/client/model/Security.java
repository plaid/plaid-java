...
public class Security {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "(Deprecated) 7-character SEDOL, an identifier assigned to securities in the UK.")
  ...
  **/
  ...
  public Security subtype(String subtype) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The security subtype of the holding.  In rare instances, a null value is returned when institutional data is insufficient to determine the security subtype.  Possible values: `asset backed security`, `bill`, `bond`, `bond with warrants`, `cash`, `cash management bill`, `common stock`, `convertible bond`, `convertible equity`, `cryptocurrency`, `depositary receipt`, `depositary receipt on debt`, `etf`, `float rating note`, `fund of funds`, `hedge fund`, `limited partnership unit`, `medium term note`, `money market debt`, `mortgage backed security`, `municipal bond`, `mutual fund`, `note`, `option`, `other`, `preferred convertible`, `preferred equity`, `private equity fund`, `real estate investment trust`, `structured equity product`, `treasury inflation protected securities`, `unit`, `warrant`.")
  ...
  **/
  ...
  public Security cfiCode(String cfiCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "The ISO-10962 Classification of Financial Instruments Code used to classify the security based on its structure and function.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "12-character FIGI, a unique Financial Instrument Global Identifier assigned to securities that is immutable and stays consistent across most corporate actions. This is an open data standard issued by the Object Management Group and administered by Bloomberg L.P.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.securityId, security.securityId) &&
        ...
        Objects.equals(this.subtype, security.subtype) &&
        ...
        Objects.equals(this.cfiCode, security.cfiCode) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(securityId, isin, cusip, sedol, institutionSecurityId, institutionId, proxySecurityId, name, tickerSymbol, isCashEquivalent, type, subtype, closePrice, closePriceAsOf, updateDatetime, isoCurrencyCode, unofficialCurrencyCode, marketIdentifierCode, sector, industry, cfiCode, figi, optionContract, fixedIncome);
  }
