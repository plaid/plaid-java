...
public class HistoricalBalance {
  ...
  public HistoricalBalance date(String date) {
   ...
   * @return date
  **/
  @ApiModelProperty(required = true, value = "The date of the calculated historical balance, in an ISO 8601 format (YYYY-MM-DD)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unofficial currency code associated with the balance. Always `null` if `iso_currency_code` is non-`null`.  See the [currency code schema](/docs/api/accounts#currency-code-schema) for a full listing of supported `iso_currency_code`s.")
