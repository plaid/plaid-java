...
public class LinkTokenCreateRequestAuth {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies what type of Reroute to Credentials pane should be used in the Link session for the Same Day Micro-deposits flow.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authTypeSelectEnabled, automatedMicrodepositsEnabled, instantMatchEnabled, sameDayMicrodepositsEnabled, rerouteToCredentials, flowType);
  }
