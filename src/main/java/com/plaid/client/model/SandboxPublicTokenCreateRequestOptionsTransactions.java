...
public class SandboxPublicTokenCreateRequestOptionsTransactions {
  ...
  **/
  ...
  @ApiModelProperty(value = "Use `days_requested` instead. This field has no effect on the amount of transaction history available on the Item.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The maximum number of days of transaction history to request for the Transactions product, matching [`transactions.days_requested`](https://plaid.com/docs/api/link/#link-token-create-request-transactions-days-requested) on `/link/token/create`. If no value is specified, this defaults to 90 days. Once Transactions has been added to an Item, this value cannot be updated.")
