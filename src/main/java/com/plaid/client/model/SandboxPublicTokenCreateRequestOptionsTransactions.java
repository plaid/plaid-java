 ...
 */
@ApiModel(description = "SandboxPublicTokenCreateRequestOptionsTransactions is an optional set of corresponding to transactions options.")
...
public class SandboxPublicTokenCreateRequestOptionsTransactions {
  ...
  public SandboxPublicTokenCreateRequestOptionsTransactions startDate(String startDate) {
  ...
  **/
  ...
  public SandboxPublicTokenCreateRequestOptionsTransactions endDate(String endDate) {
