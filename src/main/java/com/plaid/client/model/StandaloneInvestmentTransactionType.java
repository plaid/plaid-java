 ...
 */
@ApiModel(description = "Valid values for investment transaction types")
...
public class StandaloneInvestmentTransactionType {
  ...
  **/
   ...
   * @return transfer
  **/
  @ApiModelProperty(required = true, value = "Activity which modifies a position, but not through buy/sell activity e.g. options exercise, portfolio transfer")
