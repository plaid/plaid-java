...
public class Location {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ISO 3166-1 alpha-2 country code where the transaction occurred.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The latitude where the transaction occurred.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The longitude where the transaction occurred.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The merchant defined store number where the transaction occurred.")
