...
public class SignalEvaluateCoreAttributes {
  ...
  public static final String SERIALIZED_NAME_BALANCE_TO_TRANSACTION_AMOUNT_RATIO = "balance_to_transaction_amount_ratio";
  @SerializedName(SERIALIZED_NAME_BALANCE_TO_TRANSACTION_AMOUNT_RATIO)
  private Double balanceToTransactionAmountRatio;
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The 50th percentile of the end-of-day available balance between day 61 and day 90 over the past 90 days of the account that will be debited")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The 90th percentile of the end-of-day available balance between day 61 and day 90 over the past 90 days of the account that will be debited")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The 10th percentile of the end-of-day available balance between day 61 and day 90 over the past 90 days of the account that will be debited")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates if the account that will be debited is closed")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates if the account that will be debited is either frozen or restricted")
  ...
  **/
  ...
  public SignalEvaluateCoreAttributes balanceToTransactionAmountRatio(Double balanceToTransactionAmountRatio) {
    
    this.balanceToTransactionAmountRatio = balanceToTransactionAmountRatio;
    return this;
  }
   ...
   * @return balanceToTransactionAmountRatio
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Taking `available_or_current_balance` and dividing it by the transaction amount. Useful to say \"10% buffer\", for example. This is a convenience function to build Signal Rules upon.")

  public Double getBalanceToTransactionAmountRatio() {
    return balanceToTransactionAmountRatio;
  }


  public void setBalanceToTransactionAmountRatio(Double balanceToTransactionAmountRatio) {
    this.balanceToTransactionAmountRatio = balanceToTransactionAmountRatio;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.unauthorizedTransactionsCount7d, signalEvaluateCoreAttributes.unauthorizedTransactionsCount7d) &&
        ...
        Objects.equals(this.balanceToTransactionAmountRatio, signalEvaluateCoreAttributes.balanceToTransactionAmountRatio);
  }
