 ...
 */
@ApiModel(description = "The core attributes object contains additional data that can be used to assess the ACH return risk, such as past ACH return events, balance/transaction history, the Item’s connection history in the Plaid network, and identity change history.")
...
public class SignalEvaluateCoreAttributes {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Timestamp in ISO-8601 format (YYYY-MM-DDTHH:mm:ssZ) indicating the last time that the balance for the given account has been updated.")
