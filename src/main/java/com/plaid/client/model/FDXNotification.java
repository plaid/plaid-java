...
public class FDXNotification {
  ...
  **/
  ...
  public FDXNotification subtype(String subtype) {
  ...
  **/
  ...
  @ApiModelProperty(value = "An optional initiator-defined event subtype code or description if the event type needs to be further categorized or described.")
   ...
   * @return sentOn
  **/
  @ApiModelProperty(example = "2021-07-15T14:46:41.375Z", required = true, value = "ISO 8601 date-time in format 'YYYY-MM-DDThh:mm:ss.nnn[Z|[+|-]hh:mm]' according to [IETF RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.notificationId, fdXNotification.notificationId) &&
        ...
        Objects.equals(this.subtype, fdXNotification.subtype) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(notificationId, type, subtype, sentOn, category, severity, priority, publisher, subscriber, notificationPayload, url);
  }
