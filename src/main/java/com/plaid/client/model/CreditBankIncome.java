...
public class CreditBankIncome {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If data from the report was unable to be retrieved, the warnings will contain information about the error that caused the data to be incomplete.")
