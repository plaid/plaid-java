 ...
 */
@ApiModel(description = "The data from the Firstdetect product returned by Prism.")
...
public class PrismFirstDetect {
   ...
   * @return version
  **/
  @ApiModelProperty(required = true, value = "The version of Prism's Firstdetect model used.")
