...
public class PrismFirstDetect {
   ...
   * @return version
  **/
  @ApiModelProperty(required = true, value = "The version of Prism Data's FirstDetect model used.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(version, score, reasonCodes, metadata, errorReason);
  }
