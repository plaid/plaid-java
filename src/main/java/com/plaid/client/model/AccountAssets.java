...
public class AccountAssets {
  ...
  **/
  ...
  @ApiModelProperty(value = "The last 2-4 alphanumeric characters of an account's official account number. Note that the mask may be non-unique between an Item's accounts, and it may also not match the mask that the bank displays to the user.")
  ...
  **/
  ...
  public AccountAssets addTransactionsItem(AssetReportTransaction transactionsItem) {
    if (this.transactions == null) {
      this.transactions = new ArrayList<AssetReportTransaction>();
    }
  ...
  **/
  ...
  public AccountAssets addHistoricalBalancesItem(HistoricalBalance historicalBalancesItem) {
    if (this.historicalBalances == null) {
      this.historicalBalances = new ArrayList<HistoricalBalance>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Calculated data about the historical balances on the account. Only returned by Assets endpoints.")
