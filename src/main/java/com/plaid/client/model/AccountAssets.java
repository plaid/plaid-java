...
public class AccountAssets {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, balances, mask, name, officialName, type, subtype, verificationStatus, persistentAccountId, daysAvailable, transactions, owners, ownershipType, historicalBalances);
  }
