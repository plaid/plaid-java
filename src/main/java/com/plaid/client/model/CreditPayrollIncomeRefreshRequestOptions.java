...
public class CreditPayrollIncomeRefreshRequestOptions {
  ...
  **/
  ...
  @ApiModelProperty(value = "An array of `item_id`s to be refreshed. Each `item_id` should uniquely identify a payroll income item. If this field is not provided, all `item_id`s associated with the user will be refreshed.")
