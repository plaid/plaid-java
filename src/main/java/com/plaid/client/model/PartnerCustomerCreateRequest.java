...
public class PartnerCustomerCreateRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, companyName, isDiligenceAttested, products, createLinkCustomization, logo, legalEntityName, website, applicationName, technicalContact, billingContact, address, isBankAddendumCompleted, assetsUnderManagement);
  }
