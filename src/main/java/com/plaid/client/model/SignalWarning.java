...
public class SignalWarning {
  ...
  **/
  ...
  @ApiModelProperty(value = "Broad categorization of the warning.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The particular warning code.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A developer-friendly representation of the warning code.")
