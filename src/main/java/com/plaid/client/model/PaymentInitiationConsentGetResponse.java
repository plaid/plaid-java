...
public class PaymentInitiationConsentGetResponse {
  ...
  **/
   ...
   * @return scopes
  **/
  @ApiModelProperty(required = true, value = "Deprecated, use the 'type' field instead.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(consentId, status, createdAt, recipientId, reference, constraints, scopes, type, requestId);
  }
