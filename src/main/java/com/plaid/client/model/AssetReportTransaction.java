...
public class AssetReportTransaction {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(transactionType, transactionId, accountOwner, pendingTransactionId, pending, paymentChannel, paymentMeta, name, merchantName, location, authorizedDate, date, categoryId, category, unofficialCurrencyCode, isoCurrencyCode, amount, accountId, transactionCode, dateTransacted, originalDescription);
  }
