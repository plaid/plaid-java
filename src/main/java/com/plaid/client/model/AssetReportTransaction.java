...
public class AssetReportTransaction {
  ...
  **/
  ...
  public AssetReportTransaction paymentChannel(PaymentChannelEnum paymentChannel) {
  ...
  **/
  ...
  public AssetReportTransaction authorizedDate(String authorizedDate) {
  ...
  **/
  ...
  public AssetReportTransaction authorizedDatetime(String authorizedDatetime) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date and time when a transaction was authorized in ISO 8601 format ( `YYYY-MM-DDTHH:mm:ssZ` ).  This field is only populated for UK institutions. For institutions in other countries, will be `null`.")
  ...
  **/
  ...
  public AssetReportTransaction datetime(String datetime) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date and time when a transaction was posted in ISO 8601 format ( `YYYY-MM-DDTHH:mm:ssZ` ).  This field is only populated for UK institutions. For institutions in other countries, will be `null`.")
  ...
  **/
  ...
  public AssetReportTransaction transactionCode(TransactionCode transactionCode) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.transactionType, assetReportTransaction.transactionType) &&
        ...
        Objects.equals(this.paymentChannel, assetReportTransaction.paymentChannel) &&
        ...
        Objects.equals(this.authorizedDate, assetReportTransaction.authorizedDate) &&
        Objects.equals(this.authorizedDatetime, assetReportTransaction.authorizedDatetime) &&
        Objects.equals(this.date, assetReportTransaction.date) &&
        Objects.equals(this.datetime, assetReportTransaction.datetime) &&
        ...
        Objects.equals(this.transactionCode, assetReportTransaction.transactionCode) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(transactionType, transactionId, accountOwner, pendingTransactionId, pending, paymentChannel, paymentMeta, name, merchantName, location, authorizedDate, authorizedDatetime, date, datetime, categoryId, category, unofficialCurrencyCode, isoCurrencyCode, amount, accountId, transactionCode, dateTransacted, originalDescription);
  }
