...
public class AssetReportTransaction {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date on which the transaction took place, in ISO 8601 format.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The merchant name or transaction description. This is a legacy field that is no longer maintained. For merchant name, use the `merchant_name` field. For description, use the `original_description` field.  This field will only appear in an Asset Report with Insights.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The merchant name, as enriched by Plaid. This is typically a more human-readable version of the merchant counterparty in the transaction. For some bank transactions (such as checks or account transfers) where there is no meaningful merchant name, this value will be `null`.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, assetReportTransaction.accountId) &&
        ...
        Objects.equals(this.creditCategory, assetReportTransaction.creditCategory) &&
        ...
        Objects.equals(this.transactionType, assetReportTransaction.transactionType) &&
        Objects.equals(this.incomeSourceId, assetReportTransaction.incomeSourceId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, amount, isoCurrencyCode, unofficialCurrencyCode, originalDescription, category, categoryId, creditCategory, checkNumber, date, dateTransacted, location, name, merchantName, paymentMeta, pending, pendingTransactionId, accountOwner, transactionId, transactionType, incomeSourceId);
  }
