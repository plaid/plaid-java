...
public class CraCheckReportLendScoreGetResponse {
  ...
  **/
  ...
  @ApiModelProperty(value = "If the Lend Score generation was successful but a subset of data could not be retrieved, this array will contain information about the errors causing information to be missing")
