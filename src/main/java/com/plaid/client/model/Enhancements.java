...
public class Enhancements {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A link to the icon associated with the primary personal finance category. The logo will always be 100x100 resolution.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(merchantName, website, logoUrl, checkNumber, paymentChannel, categoryId, category, location, personalFinanceCategory, personalFinanceCategoryIconUrl);
  }
