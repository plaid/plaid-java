...
public class PaginatedDashboardUserListResponse {
  ...
  public PaginatedDashboardUserListResponse dashboardUsers(List<DashboardUser> dashboardUsers) {
    
    this.dashboardUsers = dashboardUsers;
    return this;
  }

  public PaginatedDashboardUserListResponse addDashboardUsersItem(DashboardUser dashboardUsersItem) {
  ...
  **/
  ...
  public PaginatedDashboardUserListResponse nextCursor(String nextCursor) {
  ...
  **/
  ...
  public PaginatedDashboardUserListResponse requestId(String requestId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PaginatedDashboardUserListResponse paginatedDashboardUserListResponse = (PaginatedDashboardUserListResponse) o;
    return Objects.equals(this.dashboardUsers, paginatedDashboardUserListResponse.dashboardUsers) &&
        Objects.equals(this.nextCursor, paginatedDashboardUserListResponse.nextCursor) &&
        Objects.equals(this.requestId, paginatedDashboardUserListResponse.requestId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dashboardUsers, nextCursor, requestId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaginatedDashboardUserListResponse {\n");
