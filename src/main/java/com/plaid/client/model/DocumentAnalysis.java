...
import com.plaid.client.model.AAMVAAnalysis;
import com.plaid.client.model.DocumentAuthenticityMatchCode;
import com.plaid.client.model.FraudAnalysisDetails;
import com.plaid.client.model.HumanReview;
import com.plaid.client.model.ImageQuality;
import com.plaid.client.model.ImageQualityDetails;
...
public class DocumentAnalysis {
  ...
  public static final String SERIALIZED_NAME_FRAUD_ANALYSIS_DETAILS = "fraud_analysis_details";
  @SerializedName(SERIALIZED_NAME_FRAUD_ANALYSIS_DETAILS)
  private FraudAnalysisDetails fraudAnalysisDetails;

  public static final String SERIALIZED_NAME_IMAGE_QUALITY_DETAILS = "image_quality_details";
  @SerializedName(SERIALIZED_NAME_IMAGE_QUALITY_DETAILS)
  private ImageQualityDetails imageQualityDetails;

  public static final String SERIALIZED_NAME_HUMAN_REVIEW = "human_review";
  @SerializedName(SERIALIZED_NAME_HUMAN_REVIEW)
  private HumanReview humanReview;

  public static final String SERIALIZED_NAME_AAMVA_VERIFICATION = "aamva_verification";
  @SerializedName(SERIALIZED_NAME_AAMVA_VERIFICATION)
  private AAMVAAnalysis aamvaVerification;
  ...
  **/
  ...
  public DocumentAnalysis fraudAnalysisDetails(FraudAnalysisDetails fraudAnalysisDetails) {
   ...
   /**
   * Get fraudAnalysisDetails
   * @return fraudAnalysisDetails
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public FraudAnalysisDetails getFraudAnalysisDetails() {
    return fraudAnalysisDetails;
  }


  public void setFraudAnalysisDetails(FraudAnalysisDetails fraudAnalysisDetails) {
    this.fraudAnalysisDetails = fraudAnalysisDetails;
  }


  public DocumentAnalysis imageQualityDetails(ImageQualityDetails imageQualityDetails) {
   ...
   /**
   * Get imageQualityDetails
   * @return imageQualityDetails
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public ImageQualityDetails getImageQualityDetails() {
    return imageQualityDetails;
  }


  public void setImageQualityDetails(ImageQualityDetails imageQualityDetails) {
    this.imageQualityDetails = imageQualityDetails;
  }


  public DocumentAnalysis humanReview(HumanReview humanReview) {
  ...
  **/
  ...
  public DocumentAnalysis aamvaVerification(AAMVAAnalysis aamvaVerification) {
   ...
   /**
   * Get aamvaVerification
   * @return aamvaVerification
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "")

  public AAMVAAnalysis getAamvaVerification() {
    return aamvaVerification;
  }


  public void setAamvaVerification(AAMVAAnalysis aamvaVerification) {
    this.aamvaVerification = aamvaVerification;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authenticity, documentAnalysis.authenticity) &&
        ...
        Objects.equals(this.fraudAnalysisDetails, documentAnalysis.fraudAnalysisDetails) &&
        Objects.equals(this.imageQualityDetails, documentAnalysis.imageQualityDetails) &&
        Objects.equals(this.humanReview, documentAnalysis.humanReview) &&
        Objects.equals(this.aamvaVerification, documentAnalysis.aamvaVerification);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authenticity, imageQuality, extractedData, fraudAnalysisDetails, imageQualityDetails, humanReview, aamvaVerification);
  }
