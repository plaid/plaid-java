...
public class DepositoryFilter {
  ...
  public DepositoryFilter accountSubtypes(List<AccountSubtype> accountSubtypes) {
    
    this.accountSubtypes = accountSubtypes;
    return this;
  }

  public DepositoryFilter addAccountSubtypesItem(AccountSubtype accountSubtypesItem) {
