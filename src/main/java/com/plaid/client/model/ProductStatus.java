 ...
 */
@ApiModel(description = "A representation of the status health of a request type. Auth requests, Balance requests, Identity requests, Transactions updates, Investments updates, and Item logins each have their own status object.")
...
public class ProductStatus {
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "`HEALTHY`: the majority of requests are successful `DEGRADED`: only some requests are successful `DOWN`: all requests are failing")
  ...
  public ProductStatus lastStatusChange(String lastStatusChange) {
  ...
  **/
  @ApiModelProperty(required = true, value = "ISO 8601 formatted timestamp of the last status change for the institution.")
