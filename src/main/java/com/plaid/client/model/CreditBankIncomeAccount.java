 ...
 */
@ApiModel(description = "The Item's accounts that have Bank Income data.")
...
public class CreditBankIncomeAccount {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The official name of the bank account.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, mask, name, officialName, subtype, type);
  }
