...
public class PaystubDetails {
  ...
  **/
  ...
  public PaystubDetails payFrequency(PayFrequencyEnum payFrequency) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The frequency at which the employee is paid. Possible values: `MONTHLY`, `BI-WEEKLY`, `WEEKLY`, `SEMI-MONTHLY`.")
