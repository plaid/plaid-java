...
public enum PlaidErrorType {
  ...
  BASE_REPORT_ERROR("BASE_REPORT_ERROR"),
  ...
  CRA_MONITORING_ERROR("CRA_MONITORING_ERROR"),
  
  CREDIT_PROFILE_REPORT_ERROR("CREDIT_PROFILE_REPORT_ERROR"),
  
  ENCOMPASS_ERROR("ENCOMPASS_ERROR"),
  
  ENRICH_ERROR("ENRICH_ERROR"),
  
  FRAUD_INSIGHTS_ERROR("FRAUD_INSIGHTS_ERROR"),
  
  FREDDIE_MAC_ERROR("FREDDIE_MAC_ERROR"),
  
  LINK_DELIVERY_ERROR("LINK_DELIVERY_ERROR"),
  
  PROFILE_ERROR("PROFILE_ERROR"),
  
  RECURRING_TRANSACTIONS_ERROR("RECURRING_TRANSACTIONS_ERROR"),
  
  STATEMENTS_ERROR("STATEMENTS_ERROR"),
  
  TRANSFER_RECURRING_ERROR("TRANSFER_RECURRING_ERROR"),
  
  TRANSFER_REFUND_ERROR("TRANSFER_REFUND_ERROR"),
