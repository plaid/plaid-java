...
public class APR {
  ...
  **/
  ...
  @ApiModelProperty(value = "Amount of money that is subjected to the APR if a balance was carried beyond payment due date. How it is calculated can vary by card issuer. It is often calculated as an average daily balance.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Amount of money charged due to interest from last statement.")
