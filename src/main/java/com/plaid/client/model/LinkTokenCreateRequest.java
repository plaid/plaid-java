...
public class LinkTokenCreateRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The destination URL to which any webhooks should be sent. Note that webhooks for Payment Initiation, Transfer, Bank Transfer (including Auth micro-deposit notification webhooks) and Identity Verification are configured via the Dashboard instead.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, clientName, language, countryCodes, user, products, additionalConsentedProducts, webhook, accessToken, linkCustomizationName, redirectUri, androidPackageName, institutionData, accountFilters, euConfig, institutionId, paymentInitiation, depositSwitch, employment, incomeVerification, auth, transfer, update, identityVerification, userToken, investments);
  }
