...
public class LinkTokenCreateRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, clientName, language, countryCodes, user, products, webhook, accessToken, linkCustomizationName, redirectUri, androidPackageName, accountFilters, institutionId, paymentInitiation, depositSwitch);
  }
