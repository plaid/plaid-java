...
public class LinkTokenCreateRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, clientName, language, countryCodes, user, products, additionalConsentedProducts, requiredIfSupportedProducts, webhook, accessToken, linkCustomizationName, redirectUri, androidPackageName, institutionData, accountFilters, euConfig, institutionId, paymentInitiation, depositSwitch, employment, incomeVerification, baseReport, consumerReportPermissiblePurpose, auth, transfer, update, identityVerification, statements, userToken, investments, investmentsAuth, hostedLink);
  }
