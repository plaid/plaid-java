...
public class MortgageLiability {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "Original date on which mortgage is due in full. Dates are returned in an ISO 8601 format (YYYY-MM-DD).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "The due date for the next payment. Dates are returned in an ISO 8601 format (YYYY-MM-DD).")
