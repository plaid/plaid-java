...
public class MortgageLiability {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The current outstanding amount charged for late payment.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total amount held in escrow to pay taxes and insurance on behalf of the borrower.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the borrower has private mortgage insurance in effect.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the borrower will pay a penalty for early payoff of mortgage.")
  ...
  **/
  ...
  public MortgageLiability lastPaymentDate(String lastPaymentDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Description of the type of loan, for example `conventional`, `fixed`, or `variable`. This field is provided directly from the loan servicer and does not have an enumerated set of possible values.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Full duration of mortgage as at origination (e.g. `10 year`).")
  ...
  public MortgageLiability maturityDate(String maturityDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Original date on which mortgage is due in full. Dates are returned in an ISO 8601 format (YYYY-MM-DD).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The amount of the next payment.")
  ...
  public MortgageLiability nextPaymentDueDate(String nextPaymentDueDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The due date for the next payment. Dates are returned in an ISO 8601 format (YYYY-MM-DD).")
  ...
  public MortgageLiability originationDate(String originationDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The original principal balance of the mortgage.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Amount of loan (principal + interest) past due for payment.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The year to date (YTD) interest paid.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The YTD principal paid.")
