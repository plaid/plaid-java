...
public class LinkTokenGetResponse {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The creation timestamp for the `link_token`, in ISO 8601 format.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "The expiration timestamp for the `link_token`, in ISO 8601 format.")
