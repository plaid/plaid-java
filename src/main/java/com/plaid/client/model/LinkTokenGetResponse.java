...
public class LinkTokenGetResponse {
  ...
  **/
  ...
  @ApiModelProperty(value = "A `link_token`, which can be supplied to Link in order to initialize it and receive a `public_token`, which can be exchanged for an `access_token`.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The creation timestamp for the `link_token`, in ISO 8601 format.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The expiration timestamp for the `link_token`, in ISO 8601 format.")
