...
public class Transaction {
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "The merchant name or transaction description.  Note: While Plaid does not currently plan to remove this field, it is a legacy field that is not actively maintained. Use `merchant_name` instead for the merchant name.  If the `transactions` object was returned by a Transactions endpoint such as `/transactions/sync` or `/transactions/get`, this field will always appear. If the `transactions` object was returned by an Assets endpoint such as `/asset_report/get` or `/asset_report/pdf/get`, this field will only appear in an Asset Report with Insights.")
  ...
  **/
  ...
  public Transaction businessFinanceCategory(BusinessFinanceCategory businessFinanceCategory) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The merchant category code for the transaction, typically a four-digit [ISO 18245](https://www.iso.org/standard/33365.html) string. This field is in beta: it is populated primarily for card transactions, coverage varies by institution, and values are subject to change.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The balance of the account after this transaction was applied, as reported by the financial institution. Returned on posted transactions only, and not populated for every institution or every transaction. May not reconcile with the balances returned by `/accounts/balance/get`.")
  ...
  public Transaction clientCustomization(ClientCustomization clientCustomization) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, transaction.accountId) &&
        ...
        Objects.equals(this.businessFinanceCategory, transaction.businessFinanceCategory) &&
