...
public class Transaction {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(transactionType, transactionId, accountOwner, pendingTransactionId, pending, paymentChannel, paymentMeta, name, merchantName, location, authorizedDate, authorizedDatetime, date, datetime, categoryId, category, unofficialCurrencyCode, isoCurrencyCode, amount, accountId, transactionCode);
  }
