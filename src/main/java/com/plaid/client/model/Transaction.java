...
public class Transaction {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(transactionType, pendingTransactionId, categoryId, category, location, paymentMeta, accountOwner, name, originalDescription, accountId, amount, isoCurrencyCode, unofficialCurrencyCode, date, pending, transactionId, merchantName, logoUrl, website, checkNumber, paymentChannel, authorizedDate, authorizedDatetime, datetime, transactionCode, personalFinanceCategory, personalFinanceCategoryIconUrl, counterparties);
  }
