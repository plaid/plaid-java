...
public class TransactionAllOf {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authorizedDate, authorizedDatetime, datetime, paymentChannel, personalFinanceCategory, businessFinanceCategory, transactionCode, personalFinanceCategoryIconUrl, counterparties, merchantEntityId);
  }
