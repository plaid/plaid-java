...
public class TransactionAllOf {
  ...
  **/
  ...
  public TransactionAllOf merchantName(String merchantName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "The date that the transaction was authorized. Dates are returned in an ISO 8601 format ( `YYYY-MM-DD` ).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "Date and time when a transaction was authorized in ISO 8601 format ( `YYYY-MM-DDTHH:mm:ssZ` ).  This field is only populated for UK institutions. For institutions in other countries, will be `null`.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "Date and time when a transaction was posted in ISO 8601 format ( `YYYY-MM-DDTHH:mm:ssZ` ).  This field is only populated for UK institutions. For institutions in other countries, will be `null`.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.paymentChannel, transactionAllOf.paymentChannel) &&
        Objects.equals(this.merchantName, transactionAllOf.merchantName) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(paymentChannel, merchantName, authorizedDate, authorizedDatetime, datetime, transactionCode);
  }
