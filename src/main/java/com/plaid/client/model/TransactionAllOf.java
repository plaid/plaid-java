...
public class TransactionAllOf {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(paymentChannel, authorizedDate, authorizedDatetime, datetime, transactionCode, personalFinanceCategory, personalFinanceCategoryIconUrl, counterparties);
  }
