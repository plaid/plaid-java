...
public class TransferCreateRequest {
  ...
  **/
  ...
  public TransferCreateRequest customTag(String customTag) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An arbitrary string provided by the client for storage with the transfer. May be up to 100 characters.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientId, transferCreateRequest.clientId) &&
        ...
        Objects.equals(this.customTag, transferCreateRequest.customTag) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, idempotencyKey, accessToken, accountId, authorizationId, type, network, amount, isoCurrencyCode, description, achClass, user, customTag, metadata, originationAccountId);
  }
