...
public class TransferCreateRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The Plaid `account_id` corresponding to the end-user account that will be debited or credited. Required when creating a transfer using an `access_token`.")
  ...
  public TransferCreateRequest paymentProfileToken(String paymentProfileToken) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The amount of the transfer (decimal string with two digits of precision e.g. \"10.00\").")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientId, transferCreateRequest.clientId) &&
        ...
        Objects.equals(this.paymentProfileToken, transferCreateRequest.paymentProfileToken) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, idempotencyKey, accessToken, accountId, paymentProfileToken, authorizationId, type, network, amount, description, achClass, user, metadata, originationAccountId, isoCurrencyCode, testClockId);
  }
