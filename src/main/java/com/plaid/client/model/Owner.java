...
public class Owner {
  ...
  **/
  ...
  public Owner documentId(String documentId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "document_id is the id of the document that this identity belongs to")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(names, phoneNumbers, emails, addresses, documentId);
  }
