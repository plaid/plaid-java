...
public class PhoneNumberMatchScore {
  ...
  **/
  ...
  @ApiModelProperty(value = "Match score for normalized phone number. 100 is a perfect match and 0 is a no match. If the phone number is missing from either the API or financial institution, this is null.")
