 ...
 */
@ApiModel(description = "Every 14 days, the webhook will be fired per item enabled for Monitoring Insights.")
...
public class MonitoringInsightsWebhook {
  ...
  **/
   ...
   * @return webhookCode
  **/
  @ApiModelProperty(required = true, value = "The status of the Monitoring Insights report generation. Possible Values: `AVAILABLE`, `PENDING`, `UNSUPPORTED`, `UNHEALTHY`")
  ...
  **/
  ...
  @ApiModelProperty(value = "The reason for why a report may not be `AVAILABLE`")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(webhookType, webhookCode, reason, userId, environment);
  }
