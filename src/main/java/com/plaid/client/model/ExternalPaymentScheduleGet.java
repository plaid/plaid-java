...
public class ExternalPaymentScheduleGet {
  ...
  **/
  ...
  @ApiModelProperty(value = "The start date sent to the bank after adjusting for holidays or weekends.  Will be provided in ISO 8601 format (YYYY-MM-DD). If the start date did not require adjustment, this field will be `null`.")
  ...
  public ExternalPaymentScheduleGet interval(String interval) {
  ...
  **/
  ...
  public ExternalPaymentScheduleGet intervalExecutionDay(Double intervalExecutionDay) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.adjustedStartDate, externalPaymentScheduleGet.adjustedStartDate) &&
        Objects.equals(this.interval, externalPaymentScheduleGet.interval) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adjustedStartDate, interval, intervalExecutionDay, startDate, endDate);
  }
