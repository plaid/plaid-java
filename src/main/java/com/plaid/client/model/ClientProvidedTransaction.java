...
public class ClientProvidedTransaction {
  ...
  **/
  ...
  public ClientProvidedTransaction userId(String userId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The Plaid generated ID that identifies the end user for whom you would like to enrich transactions.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, clientProvidedTransaction.id) &&
        Objects.equals(this.userId, clientProvidedTransaction.userId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, userId, clientUserId, clientAccountId, accountType, accountSubtype, description, amount, direction, isoCurrencyCode, location, mcc, datePosted);
  }
