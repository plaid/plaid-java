...
public class JWKPublicKey {
  ...
  **/
  ...
  @ApiModelProperty(value = "The alg member identifies the cryptographic algorithm family used with the key.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The crv member identifies the cryptographic curve used with the key.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The kid (Key ID) member can be used to match a specific key. This can be used, for instance, to choose among a set of keys within the JWK during key rollover.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The use (public key use) parameter identifies the intended use of the public key.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The x member contains the x coordinate for the elliptic curve point.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The y member contains the y coordinate for the elliptic curve point.")
