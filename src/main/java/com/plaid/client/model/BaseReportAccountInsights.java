...
public class BaseReportAccountInsights {
  ...
  **/
  ...
  @ApiModelProperty(value = "Date of the earliest transaction for the account.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date of the most recent transaction for the account.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Number of days days available for the account.")
