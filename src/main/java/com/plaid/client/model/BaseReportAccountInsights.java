...
public class BaseReportAccountInsights {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Average amount of debit transactions into the account. This array will be empty for non-depository accounts. This field only takes into account USD transactions from the account.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Average amount of transactions out of the account. This array will be empty for non-depository accounts. This field only takes into account USD transactions from the account.")
