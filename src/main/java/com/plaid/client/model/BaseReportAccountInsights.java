...
public class BaseReportAccountInsights {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Customers must transition from `longest_gap_between_transactions` by October 31st 2024. Longest gap between sequential transactions in a time period. This array can include multiple time periods.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Customers must transition from `average_inflow_amount` by October 31st 2024. Average amount of debit transactions into the account in a time period. This array will be empty for non-depository accounts. This field only takes into account USD transactions from the account.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Customers must transition from `average_outflow_amount` by October 31st 2024. Average amount of transactions out of the account in a time period. This array will be empty for non-depository accounts. This field only takes into account USD transactions from the account.")
