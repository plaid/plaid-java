...
public class PaymentInitiationPayment {
  ...
  **/
  ...
  public PaymentInitiationPayment error(PlaidError error) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.paymentId, paymentInitiationPayment.paymentId) &&
        ...
        Objects.equals(this.error, paymentInitiationPayment.error);
  }

  @Override
  public int hashCode() {
    return Objects.hash(paymentId, amount, status, recipientId, reference, adjustedReference, lastStatusUpdate, schedule, refundDetails, bacs, iban, refundIds, amountRefunded, walletId, scheme, adjustedScheme, consentId, transactionId, endToEndId, error);
  }
