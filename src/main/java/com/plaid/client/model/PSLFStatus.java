...
public class PSLFStatus {
  ...
  public PSLFStatus estimatedEligibilityDate(String estimatedEligibilityDate) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The estimated date borrower will have completed 120 qualifying monthly payments. Returned in ISO 8601 format (YYYY-MM-DD).")
  ...
  public void setEstimatedEligibilityDate(String estimatedEligibilityDate) {
    this.estimatedEligibilityDate = estimatedEligibilityDate;
  }


  public PSLFStatus paymentsMade(Double paymentsMade) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of qualifying payments that have been made.")
  ...
  public PSLFStatus paymentsRemaining(Double paymentsRemaining) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of qualifying payments remaining.")
