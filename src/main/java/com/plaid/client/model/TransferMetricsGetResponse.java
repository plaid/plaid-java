...
public class TransferMetricsGetResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(requestId, dailyDebitTransferVolume, dailyCreditTransferVolume, monthlyTransferVolume, monthlyDebitTransferVolume, monthlyCreditTransferVolume, isoCurrencyCode, returnRates);
  }
