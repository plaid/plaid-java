...
import com.plaid.client.model.ReportToken;
...
public class CreditAuditCopyTokenCreateRequest {
  ...
  private List<ReportToken> reportTokens = new ArrayList<>();
  ...
  **/
  ...
  public CreditAuditCopyTokenCreateRequest reportTokens(List<ReportToken> reportTokens) {
    
    this.reportTokens = reportTokens;
    return this;
  }

  public CreditAuditCopyTokenCreateRequest addReportTokensItem(ReportToken reportTokensItem) {
   ...
   * @return reportTokens
  **/
  @ApiModelProperty(required = true, value = "List of report tokens; can include both Asset Report tokens and Income Report tokens.")
  ...
  public void setReportTokens(List<ReportToken> reportTokens) {
    this.reportTokens = reportTokens;
  }


  public CreditAuditCopyTokenCreateRequest auditorId(String auditorId) {
   ...
   * @return auditorId
  **/
  @ApiModelProperty(required = true, value = "The `auditor_id` of the third party with whom you would like to share the Asset Report and/or Income Report.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientId, creditAuditCopyTokenCreateRequest.clientId) &&
        ...
        Objects.equals(this.auditorId, creditAuditCopyTokenCreateRequest.auditorId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, reportTokens, auditorId);
  }
