...
public class TransferEventListRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, startDate, endDate, transferId, accountId, transferType, eventTypes, sweepId, count, offset, originationAccountId, originatorClientId);
  }
