...
import com.plaid.client.model.LineOfCreditLiability;
import com.plaid.client.model.LoanLiability;
...
public class LiabilitiesObject {
  ...
  private List<LoanLiability> loan = null;

  public static final String SERIALIZED_NAME_LINE_OF_CREDIT = "line_of_credit";
  @SerializedName(SERIALIZED_NAME_LINE_OF_CREDIT)
  private List<LineOfCreditLiability> lineOfCredit = null;
  ...
  **/
  ...
  public LiabilitiesObject loan(List<LoanLiability> loan) {
    
    this.loan = loan;
    return this;
  }

  public LiabilitiesObject addLoanItem(LoanLiability loanItem) {
    if (this.loan == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The closed-end loan accounts returned.")

  public List<LoanLiability> getLoan() {
    return loan;
  }


  public void setLoan(List<LoanLiability> loan) {
    this.loan = loan;
  }


  public LiabilitiesObject lineOfCredit(List<LineOfCreditLiability> lineOfCredit) {
    
    this.lineOfCredit = lineOfCredit;
    return this;
  }

  public LiabilitiesObject addLineOfCreditItem(LineOfCreditLiability lineOfCreditItem) {
    if (this.lineOfCredit == null) {
      this.lineOfCredit = new ArrayList<>();
    }
    this.lineOfCredit.add(lineOfCreditItem);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The line of credit accounts returned.")

  public List<LineOfCreditLiability> getLineOfCredit() {
    return lineOfCredit;
  }


  public void setLineOfCredit(List<LineOfCreditLiability> lineOfCredit) {
    this.lineOfCredit = lineOfCredit;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.credit, liabilitiesObject.credit) &&
        ...
        Objects.equals(this.loan, liabilitiesObject.loan) &&
        Objects.equals(this.lineOfCredit, liabilitiesObject.lineOfCredit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(credit, mortgage, student, loan, lineOfCredit);
  }
