...
public class WatchlistScreeningEntityReviewCreateRequest {
  ...
  **/
  @ApiModelProperty(required = true, value = "Hits to mark as a true positive after thorough manual review. These hits will never recur or be updated once confirmed. In most cases, confirmed hits indicate that the customer should be rejected.")
