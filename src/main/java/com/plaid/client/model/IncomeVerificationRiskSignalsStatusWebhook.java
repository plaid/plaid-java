 ...
 */
@ApiModel(description = "Fired when the risk signal computation for all uploaded documents in an income verification is completed. It will typically take several minutes for this webhook to fire after the end user has uploaded their documents in the Document Income flow.")
