...
public class ClientProvidedTransactionLocation {
  ...
  **/
  ...
  @ApiModelProperty(value = "The country where the transaction occurred, formatted as an ISO 3166-1 alpha-2 country code (\"US\" or \"CA\").")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The region or state where the transaction occurred, formatted as the official two-letter US state or Canadian province postal code, e.g. \"CT\" or \"QC\".")
