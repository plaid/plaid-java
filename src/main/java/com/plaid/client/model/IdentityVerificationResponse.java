...
public class IdentityVerificationResponse {
  ...
  public IdentityVerificationResponse id(String id) {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "idver_52xR9LKo77r1Np", required = true, value = "ID of the associated Identity Verification attempt.")
  ...
  public IdentityVerificationResponse clientUserId(String clientUserId) {
  ...
  **/
  ...
  public IdentityVerificationResponse createdAt(java.sql.Timestamp createdAt) {
  ...
  **/
  ...
  public IdentityVerificationResponse completedAt(OffsetDateTime completedAt) {
  ...
  **/
  ...
  public IdentityVerificationResponse previousAttemptId(String previousAttemptId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "idver_42cF1MNo42r9Xj", required = true, value = "The ID for the Identity Verification preceding this session. This field will only be filled if the current Identity Verification is a retry of a previous attempt.")
  ...
  public IdentityVerificationResponse shareableUrl(String shareableUrl) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://flow.plaid.com/verify/idver_4FrXJvfQU3zGUR?key=e004115db797f7cc3083bff3167cba30644ef630fb46f5b086cde6cc3b86a36f", required = true, value = "A shareable URL that can be sent directly to the user to complete verification")
  ...
  public IdentityVerificationResponse template(IdentityVerificationTemplateReference template) {
  ...
  **/
  ...
  public IdentityVerificationResponse user(IdentityVerificationUserData user) {
  ...
  **/
  ...
  public IdentityVerificationResponse status(IdentityVerificationStatus status) {
  ...
  **/
  ...
  public IdentityVerificationResponse steps(IdentityVerificationStepSummary steps) {
  ...
  **/
  ...
  public IdentityVerificationResponse documentaryVerification(DocumentaryVerification documentaryVerification) {
  ...
  **/
  ...
  public IdentityVerificationResponse kycCheck(KYCCheckDetails kycCheck) {
  ...
  **/
  ...
  public IdentityVerificationResponse watchlistScreeningId(String watchlistScreeningId) {
  ...
  **/
  ...
  public IdentityVerificationResponse requestId(String requestId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IdentityVerificationResponse identityVerificationResponse = (IdentityVerificationResponse) o;
    return Objects.equals(this.id, identityVerificationResponse.id) &&
        Objects.equals(this.clientUserId, identityVerificationResponse.clientUserId) &&
        Objects.equals(this.createdAt, identityVerificationResponse.createdAt) &&
        Objects.equals(this.completedAt, identityVerificationResponse.completedAt) &&
        Objects.equals(this.previousAttemptId, identityVerificationResponse.previousAttemptId) &&
        Objects.equals(this.shareableUrl, identityVerificationResponse.shareableUrl) &&
        Objects.equals(this.template, identityVerificationResponse.template) &&
        Objects.equals(this.user, identityVerificationResponse.user) &&
        Objects.equals(this.status, identityVerificationResponse.status) &&
        Objects.equals(this.steps, identityVerificationResponse.steps) &&
        Objects.equals(this.documentaryVerification, identityVerificationResponse.documentaryVerification) &&
        Objects.equals(this.kycCheck, identityVerificationResponse.kycCheck) &&
        Objects.equals(this.watchlistScreeningId, identityVerificationResponse.watchlistScreeningId) &&
        Objects.equals(this.requestId, identityVerificationResponse.requestId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, clientUserId, createdAt, completedAt, previousAttemptId, shareableUrl, template, user, status, steps, documentaryVerification, kycCheck, watchlistScreeningId, requestId);
  }
