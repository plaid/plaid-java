...
public class ExternalPaymentSchedule {
  ...
  public ExternalPaymentSchedule interval(PaymentScheduleInterval interval) {
  ...
  **/
  ...
  public ExternalPaymentSchedule intervalExecutionDay(Integer intervalExecutionDay) {
