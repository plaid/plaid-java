...
public class Activity {
  ...
  **/
  ...
  public Activity initiatedDate(String initiatedDate) {
  ...
  **/
  @ApiModelProperty(example = "2020-01-01", required = true, value = "The date and time this activity was initiated [ISO 8601](https://wikipedia.org/wiki/ISO_8601) (YYYY-MM-DD) format in UTC.")
  ...
  **/
  ...
  @ApiModelProperty(value = "This field will map to the application ID that is returned from /item/applications/list, or provided to the institution in an oauth redirect.")
