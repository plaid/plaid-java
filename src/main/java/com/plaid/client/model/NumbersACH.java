...
public class NumbersACH {
  ...
  **/
   ...
   * @return account
  **/
  @ApiModelProperty(required = true, value = "The ACH account number for the account.  At certain institutions, including Chase, PNC, and US Bank, you will receive a \"tokenized\" account number, which is not the user's actual account number. For important details on how this may impact your integration and on how to avoid fraud, user confusion, and ACH returns, see [Tokenized account numbers](https://plaid.com/docs/auth/#tokenized-account-numbers).")
  ...
  **/
   ...
   * @return routing
  **/
  @ApiModelProperty(required = true, value = "The ACH routing number for the account. For more information, see [Tokenized account numbers](https://plaid.com/docs/auth/#tokenized-account-numbers).")
