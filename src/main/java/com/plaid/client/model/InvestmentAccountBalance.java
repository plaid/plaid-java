...
import com.plaid.client.model.InvestmentAccountBalanceAllOf;
...
public class InvestmentAccountBalance {
  ...
  public InvestmentAccountBalance available(Double available) {
  ...
  **/
  ...
  public InvestmentAccountBalance current(Double current) {
  ...
  **/
  ...
  public InvestmentAccountBalance limit(Double limit) {
  ...
  **/
  ...
  public InvestmentAccountBalance isoCurrencyCode(String isoCurrencyCode) {
  ...
  **/
  ...
  public InvestmentAccountBalance unofficialCurrencyCode(String unofficialCurrencyCode) {
  ...
  **/
  ...
  public InvestmentAccountBalance lastUpdatedDatetime(OffsetDateTime lastUpdatedDatetime) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Timestamp in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format (`YYYY-MM-DDTHH:mm:ssZ`) indicating the last time the balance was updated.  This field is returned only when the institution is `ins_128026` (Capital One).")
  ...
  public InvestmentAccountBalance marginLoanAmount(Double marginLoanAmount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    InvestmentAccountBalance investmentAccountBalance = (InvestmentAccountBalance) o;
    return Objects.equals(this.available, investmentAccountBalance.available) &&
        Objects.equals(this.current, investmentAccountBalance.current) &&
        Objects.equals(this.limit, investmentAccountBalance.limit) &&
        Objects.equals(this.isoCurrencyCode, investmentAccountBalance.isoCurrencyCode) &&
        Objects.equals(this.unofficialCurrencyCode, investmentAccountBalance.unofficialCurrencyCode) &&
        Objects.equals(this.lastUpdatedDatetime, investmentAccountBalance.lastUpdatedDatetime) &&
        Objects.equals(this.marginLoanAmount, investmentAccountBalance.marginLoanAmount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(available, current, limit, isoCurrencyCode, unofficialCurrencyCode, lastUpdatedDatetime, marginLoanAmount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InvestmentAccountBalance {\n");
