...
public class EntityWatchlistScreeningHit {
  ...
  public static final String SERIALIZED_NAME_SUB_PROGRAMS = "sub_programs";
  @SerializedName(SERIALIZED_NAME_SUB_PROGRAMS)
  private List<String> subPrograms = new ArrayList<>();
  ...
  **/
  ...
  public EntityWatchlistScreeningHit subPrograms(List<String> subPrograms) {
    
    this.subPrograms = subPrograms;
    return this;
  }

  public EntityWatchlistScreeningHit addSubProgramsItem(String subProgramsItem) {
    this.subPrograms.add(subProgramsItem);
    return this;
  }
   ...
   * @return subPrograms
  **/
  @ApiModelProperty(example = "[\"SDGT\",\"SDNTK\"]", required = true, value = "Sub-program designations that may be attached to the watchlist entry by the issuing authority. For OFAC SDN entries these are the program codes published in the SDN list (for example `SDGT` for Specially Designated Global Terrorists, `SDNTK` for Specially Designated Narcotics Trafficking Kingpins, `IRAN`, `RUSSIA-EO14024`). New codes are added by sanctioning authorities without prior notice, so callers should treat unknown values as opaque strings rather than enum members. ")
  ...
  public void setSubPrograms(List<String> subPrograms) {
    this.subPrograms = subPrograms;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, entityWatchlistScreeningHit.id) &&
        ...
        Objects.equals(this.subPrograms, entityWatchlistScreeningHit.subPrograms) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, reviewStatus, firstActive, inactiveSince, historicalSince, listCode, plaidUid, sourceUid, subPrograms, analysis, data);
  }
