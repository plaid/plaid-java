...
public class EntityWatchlistScreeningHit {
  ...
  private java.sql.Timestamp inactiveSince;
  ...
  private java.sql.Timestamp historicalSince;

  public static final String SERIALIZED_NAME_ENTITY_LIST_CODE = "entity_list_code";
  @SerializedName(SERIALIZED_NAME_ENTITY_LIST_CODE)
  private EntityWatchlistCode entityListCode;
  ...
  **/
  ...
  public EntityWatchlistScreeningHit inactiveSince(java.sql.Timestamp inactiveSince) {
  ...
  **/
  ...
  public java.sql.Timestamp getInactiveSince() {
    return inactiveSince;
  }


  public void setInactiveSince(java.sql.Timestamp inactiveSince) {
    this.inactiveSince = inactiveSince;
  }


  public EntityWatchlistScreeningHit historicalSince(java.sql.Timestamp historicalSince) {
  ...
  **/
  ...
  public java.sql.Timestamp getHistoricalSince() {
    return historicalSince;
  }


  public void setHistoricalSince(java.sql.Timestamp historicalSince) {
    this.historicalSince = historicalSince;
  }


  public EntityWatchlistScreeningHit entityListCode(EntityWatchlistCode entityListCode) {
    
    this.entityListCode = entityListCode;
    return this;
  }

   /**
   * Get entityListCode
   * @return entityListCode
  **/
  @ApiModelProperty(required = true, value = "")

  public EntityWatchlistCode getEntityListCode() {
    return entityListCode;
  }


  public void setEntityListCode(EntityWatchlistCode entityListCode) {
    this.entityListCode = entityListCode;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, entityWatchlistScreeningHit.id) &&
        ...
        Objects.equals(this.entityListCode, entityWatchlistScreeningHit.entityListCode) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, reviewStatus, firstActive, inactiveSince, historicalSince, entityListCode, plaidUid, sourceUid, analysis, data);
  }
  ...
  public String toString() {
    ...
    sb.append("    entityListCode: ").append(toIndentedString(entityListCode)).append("\n");
