...
public class WalletTransactionExecuteRequest {
  ...
  **/
  ...
  public WalletTransactionExecuteRequest userId(String userId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The `user_id` of the end user the transaction is for, as returned by [`/user/create`](https://plaid.com/docs/api/users/#usercreate). The user must have a `name` and either an email address or a phone number. Required for new integrations.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientId, walletTransactionExecuteRequest.clientId) &&
        ...
        Objects.equals(this.userId, walletTransactionExecuteRequest.userId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, idempotencyKey, walletId, counterparty, amount, userId, reference, originatingFundSource);
  }
