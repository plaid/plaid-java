...
public class LinkTokenCreateRequestUser {
  ...
  **/
  ...
  @ApiModelProperty(value = "The user's full legal name. Currently used only to support certain legacy flows.")
  ...
  public LinkTokenCreateRequestUser name(UserName name) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The user's full name. Optional if using the [Identity Verification](https://plaid.com/docs/api/products/identity-verification) product; if not using Identity Verification, this field is not allowed. Users will not be asked for their name when this field is provided.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "To be provided in the format \"ddd-dd-dddd\". Not currently used.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "To be provided in the format \"yyyy-mm-dd\". Not currently used.")
