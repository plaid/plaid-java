 ...
 */
@ApiModel(description = "The data from the Cash Score product returned by Prism.")
...
public class PrismCashScore {
   ...
   * @return version
  **/
  @ApiModelProperty(required = true, value = "The version of Prism's cash score model used.")
