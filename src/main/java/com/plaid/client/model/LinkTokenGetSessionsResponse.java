 ...
 */
@ApiModel(description = "An object containing information about a link session. This field will only be present if your client is enabled for Hosted Link (beta). Session data will be provided for up to six hours after the session has ended.")
...
public class LinkTokenGetSessionsResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(linkSessionId, startedAt, finishedAt, onSuccess, onExit, events);
  }
