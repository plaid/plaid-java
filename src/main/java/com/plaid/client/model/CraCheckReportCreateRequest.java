...
public class CraCheckReportCreateRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, userToken, userId, webhook, daysRequested, daysRequired, clientReportId, products, baseReport, cashflowInsights, partnerInsights, lendScore, includeInvestments, consumerReportPermissiblePurpose);
  }
