...
public class CraCheckReportCreateRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, userToken, webhook, daysRequested, daysRequired, clientReportId, products, baseReport, cashflowInsights, partnerInsights, consumerReportPermissiblePurpose);
  }
