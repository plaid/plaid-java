...
import com.plaid.client.model.CraCheckReportIncomeInsightsGetOptions;
import com.plaid.client.model.CraCheckReportLendScoreGetOptions;
import com.plaid.client.model.CraCheckReportNetworkInsightsGetOptions;
...
public class CraCheckReportCreateRequest {
  ...
  private CraCheckReportLendScoreGetOptions lendScore;
  ...
  private CraCheckReportNetworkInsightsGetOptions networkInsights;
  ...
  private CraCheckReportIncomeInsightsGetOptions incomeInsights;
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies a list of products that will be eagerly generated when creating the report (in addition to the Base Report, which is always eagerly generated). These products will be made available before a success webhook is sent. Use this option to minimize response latency for product `/get` endpoints. Note that specifying `cra_partner_insights` in this field will trigger a billable event. Other products are not billed until the respective reports are fetched via product-specific `/get` endpoints.")
  ...
  **/
  ...
  public CraCheckReportCreateRequest lendScore(CraCheckReportLendScoreGetOptions lendScore) {
  ...
  **/
  ...
  public CraCheckReportLendScoreGetOptions getLendScore() {
    return lendScore;
  }


  public void setLendScore(CraCheckReportLendScoreGetOptions lendScore) {
    this.lendScore = lendScore;
  }


  public CraCheckReportCreateRequest networkInsights(CraCheckReportNetworkInsightsGetOptions networkInsights) {
  ...
  **/
  ...
  public CraCheckReportNetworkInsightsGetOptions getNetworkInsights() {
    return networkInsights;
  }


  public void setNetworkInsights(CraCheckReportNetworkInsightsGetOptions networkInsights) {
    this.networkInsights = networkInsights;
  }
  ...
  **/
  ...
  public CraCheckReportCreateRequest incomeInsights(CraCheckReportIncomeInsightsGetOptions incomeInsights) {
  ...
  **/
  ...
  public CraCheckReportIncomeInsightsGetOptions getIncomeInsights() {
    return incomeInsights;
  }


  public void setIncomeInsights(CraCheckReportIncomeInsightsGetOptions incomeInsights) {
    this.incomeInsights = incomeInsights;
  }
