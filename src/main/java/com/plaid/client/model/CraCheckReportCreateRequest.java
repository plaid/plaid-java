...
public class CraCheckReportCreateRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, userId, userToken, webhook, daysRequested, daysRequired, clientReportId, products, baseReport, cashflowInsights, partnerInsights, lendScore, networkInsights, includeInvestments, consumerReportPermissiblePurpose);
  }
