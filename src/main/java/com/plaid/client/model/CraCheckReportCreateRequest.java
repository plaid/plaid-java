...
import com.plaid.client.model.CraCheckReportCreateCashflowInsightsOptions;
import com.plaid.client.model.CraCheckReportCreateIncomeInsightsOptions;
import com.plaid.client.model.CraCheckReportCreateLendScoreOptions;
import com.plaid.client.model.CraCheckReportCreateNetworkInsightsOptions;
import com.plaid.client.model.CraCheckReportCreatePartnerInsightsOptions;
...
public class CraCheckReportCreateRequest {
  ...
  private CraCheckReportCreateCashflowInsightsOptions cashflowInsights;
  ...
  private CraCheckReportCreatePartnerInsightsOptions partnerInsights;

  public static final String SERIALIZED_NAME_LEND_SCORE = "lend_score";
  @SerializedName(SERIALIZED_NAME_LEND_SCORE)
  private CraCheckReportCreateLendScoreOptions lendScore;
  ...
  private CraCheckReportCreateNetworkInsightsOptions networkInsights;
  ...
  private CraCheckReportCreateIncomeInsightsOptions incomeInsights;
  ...
  **/
  ...
  public CraCheckReportCreateRequest userId(String userId) {
  ...
  **/
  ...
  public CraCheckReportCreateRequest clientReportId(String clientReportId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies a list of products to generate when creating the report (in addition to the Base Report, which is always generated). These products will be made available before a success webhook is sent. Note that specifying `cra_partner_insights` in this field will trigger a billable event. Other products are not billed until the respective reports are retrieved via their product-specific `/get` endpoints.")
  ...
  **/
  ...
  public CraCheckReportCreateRequest cashflowInsights(CraCheckReportCreateCashflowInsightsOptions cashflowInsights) {
  ...
  **/
  ...
  public CraCheckReportCreateCashflowInsightsOptions getCashflowInsights() {
    return cashflowInsights;
  }


  public void setCashflowInsights(CraCheckReportCreateCashflowInsightsOptions cashflowInsights) {
    this.cashflowInsights = cashflowInsights;
  }


  public CraCheckReportCreateRequest partnerInsights(CraCheckReportCreatePartnerInsightsOptions partnerInsights) {
  ...
  **/
  ...
  public CraCheckReportCreatePartnerInsightsOptions getPartnerInsights() {
    return partnerInsights;
  }


  public void setPartnerInsights(CraCheckReportCreatePartnerInsightsOptions partnerInsights) {
    this.partnerInsights = partnerInsights;
  }


  public CraCheckReportCreateRequest lendScore(CraCheckReportCreateLendScoreOptions lendScore) {
  ...
  **/
  ...
  public CraCheckReportCreateLendScoreOptions getLendScore() {
    return lendScore;
  }


  public void setLendScore(CraCheckReportCreateLendScoreOptions lendScore) {
    this.lendScore = lendScore;
  }


  public CraCheckReportCreateRequest networkInsights(CraCheckReportCreateNetworkInsightsOptions networkInsights) {
  ...
  **/
  ...
  public CraCheckReportCreateNetworkInsightsOptions getNetworkInsights() {
    return networkInsights;
  }


  public void setNetworkInsights(CraCheckReportCreateNetworkInsightsOptions networkInsights) {
    this.networkInsights = networkInsights;
  }


  public CraCheckReportCreateRequest includeInvestments(Boolean includeInvestments) {
  ...
  **/
  ...
  public CraCheckReportCreateRequest incomeInsights(CraCheckReportCreateIncomeInsightsOptions incomeInsights) {
  ...
  **/
  ...
  public CraCheckReportCreateIncomeInsightsOptions getIncomeInsights() {
    return incomeInsights;
  }


  public void setIncomeInsights(CraCheckReportCreateIncomeInsightsOptions incomeInsights) {
    this.incomeInsights = incomeInsights;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientId, craCheckReportCreateRequest.clientId) &&
        ...
        Objects.equals(this.userId, craCheckReportCreateRequest.userId) &&
        ...
        Objects.equals(this.clientReportId, craCheckReportCreateRequest.clientReportId) &&
        ...
        Objects.equals(this.lendScore, craCheckReportCreateRequest.lendScore) &&
        Objects.equals(this.networkInsights, craCheckReportCreateRequest.networkInsights) &&
        Objects.equals(this.includeInvestments, craCheckReportCreateRequest.includeInvestments) &&
        Objects.equals(this.incomeInsights, craCheckReportCreateRequest.incomeInsights) &&
        Objects.equals(this.consumerReportPermissiblePurpose, craCheckReportCreateRequest.consumerReportPermissiblePurpose);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientId, secret, userId, userToken, webhook, daysRequested, daysRequired, clientReportId, products, baseReport, cashflowInsights, partnerInsights, lendScore, networkInsights, includeInvestments, incomeInsights, consumerReportPermissiblePurpose);
  }
