...
public class InvestmentsTransactionsGetRequest {
  ...
  **/
   ...
   * @return startDate
  **/
  @ApiModelProperty(required = true, value = "The earliest date for which to fetch transaction history. Dates should be formatted as YYYY-MM-DD. Plaid returns all investment transaction history stored for the Item (up to 2 years prior to the initial linking of the Item).")
