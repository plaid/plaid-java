...
public class LinkTokenGetMetadataResponse {
  ...
  private List<Products> initialProducts = null;
  ...
  public LinkTokenGetMetadataResponse addInitialProductsItem(Products initialProductsItem) {
    if (this.initialProducts == null) {
      this.initialProducts = new ArrayList<Products>();
    }
  ...
  **/
  ...
  @ApiModelProperty(value = "The `products` specified in the `/link/token/create` call.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The `webhook` specified in the `/link/token/create` call.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The `country_codes` specified in the `/link/token/create` call.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The `language` specified in the `/link/token/create` call.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The `redirect_uri` specified in the `/link/token/create` call.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The `client_name` specified in the `/link/token/create` call.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(initialProducts, webhook, countryCodes, language, accountFilters, redirectUri, clientName);
  }
