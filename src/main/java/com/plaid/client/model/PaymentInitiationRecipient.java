...
import com.plaid.client.model.PaymentInitiationRecipientBacs;
 ...
 */
@ApiModel(description = "Information about a payment recipient configured for the Payment Initiation product")
...
public class PaymentInitiationRecipient {
  ...
  private PaymentInitiationRecipientBacs bacs;
   ...
   * @return recipientId
  **/
  @ApiModelProperty(required = true, value = "The ID of the recipient. Like all Plaid identifiers, the `recipient_id` is case sensitive.")
  ...
  **/
  ...
  public PaymentInitiationRecipient bacs(PaymentInitiationRecipientBacs bacs) {
  ...
  **/
  ...
  public PaymentInitiationRecipientBacs getBacs() {
    return bacs;
  }


  public void setBacs(PaymentInitiationRecipientBacs bacs) {
    this.bacs = bacs;
  }
