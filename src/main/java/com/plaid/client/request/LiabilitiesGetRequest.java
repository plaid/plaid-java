...
/**
 * Request for the /liabilities/get endpoint.
 *
 * @see <a href="https://plaid.com/docs/api/">https://plaid.com/docs/api</a>
 */
public final class LiabilitiesGetRequest extends BaseAccessTokenRequest {
  private Options options;

  public LiabilitiesGetRequest(String accessToken) {
    super(accessToken);
  }

  public LiabilitiesGetRequest withAccountIds(List<String> accountIds) {
