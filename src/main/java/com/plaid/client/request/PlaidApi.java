...
import com.plaid.client.model.ItemHandleFraudReportRequest;
import com.plaid.client.model.ItemHandleFraudReportResponse;
import com.plaid.client.model.ItemImportRequest;
import com.plaid.client.model.ItemImportResponse;
import com.plaid.client.model.ItemProductsTerminateRequest;
import com.plaid.client.model.ItemProductsTerminateResponse;
...
import com.plaid.client.model.ProcessorInvestmentsAuthGetRequest;
import com.plaid.client.model.ProcessorInvestmentsAuthGetResponse;
...
public interface PlaidApi {
   ...
   * @deprecated
   * 
   * @see <a href="/api/products/transactions/#categoriesget">(Deprecated) Get legacy categories Documentation</a>
   */
  @Deprecated
  @Headers({
    "Content-Type:application/json"
  ...
  Call<CraCheckReportLendScoreGetResponse> craCheckReportLendScoreGet(
    @retrofit2.http.Body CraCheckReportLendScoreGetRequest craCheckReportLendScoreGetRequest
  );
   ...
   * @param itemHandleFraudReportRequest  (required)
   * @return Call&lt;ItemHandleFraudReportResponse&gt;
   * 
   * @see <a href="/api/items/#itemhandlefraudreport">Report fraud for an Item Documentation</a>
   */
  @Headers({
    "Content-Type:application/json"
  })
  @POST("item/handle_fraud_report")
  Call<ItemHandleFraudReportResponse> itemHandleFraudReport(
    @retrofit2.http.Body ItemHandleFraudReportRequest itemHandleFraudReportRequest
  );
   ...
   * @param itemProductsTerminateRequest  (required)
   * @return Call&lt;ItemProductsTerminateResponse&gt;
   * 
   * @see <a href="/api/items/#itemproductsterminate">Terminate products for an Item Documentation</a>
   */
  @Headers({
    "Content-Type:application/json"
  })
  @POST("item/products/terminate")
  Call<ItemProductsTerminateResponse> itemProductsTerminate(
    @retrofit2.http.Body ItemProductsTerminateRequest itemProductsTerminateRequest
  );
   ...
   * @param networkStatusGetRequest  (required)
   * @return Call&lt;NetworkStatusGetResponse&gt;
   * 
   * @see <a href="/api/network/#networkstatusget">Check a user&#39;s Plaid Network status Documentation</a>
   */
  @Headers({
    "Content-Type:application/json"
  })
   ...
   * @param processorInvestmentsAuthGetRequest  (required)
   * @return Call&lt;ProcessorInvestmentsAuthGetResponse&gt;
   * 
   * @see <a href="/api/processor-partners/#processorinvestmentsauthget">Get investment account authentication data Documentation</a>
   */
  @Headers({
    "Content-Type:application/json"
  })
  @POST("processor/investments/auth/get")
  Call<ProcessorInvestmentsAuthGetResponse> processorInvestmentsAuthGet(
    @retrofit2.http.Body ProcessorInvestmentsAuthGetRequest processorInvestmentsAuthGetRequest
  );
   ...
   * @param processorInvestmentsHoldingsGetRequest  (required)
   * @return Call&lt;ProcessorInvestmentsHoldingsGetResponse&gt;
   * 
   * @see <a href="/api/processor-partners/#processorinvestmentsholdingsget">Retrieve Investment Holdings Documentation</a>
   */
  @Headers({
    "Content-Type:application/json"
  })
  @POST("processor/investments/holdings/get")
  Call<ProcessorInvestmentsHoldingsGetResponse> processorInvestmentsHoldingsGet(
    @retrofit2.http.Body ProcessorInvestmentsHoldingsGetRequest processorInvestmentsHoldingsGetRequest
  );
   ...
   * @param processorInvestmentsTransactionsGetRequest  (required)
   * @return Call&lt;ProcessorInvestmentsTransactionsGetResponse&gt;
   * 
   * @see <a href="/api/processor-partners/#processorinvestmentstransactionsget">Get investment transactions data Documentation</a>
   */
  @Headers({
    "Content-Type:application/json"
  })
  @POST("processor/investments/transactions/get")
  Call<ProcessorInvestmentsTransactionsGetResponse> processorInvestmentsTransactionsGet(
    @retrofit2.http.Body ProcessorInvestmentsTransactionsGetRequest processorInvestmentsTransactionsGetRequest
  );
   ...
   * @param sandboxPaymentSimulateRequest  (required)
   * @return Call&lt;SandboxPaymentSimulateResponse&gt;
   * 
   * @see <a href="/api/sandbox/#sandboxpaymentsimulate">Simulate a payment event in Sandbox Documentation</a>
   */
  @Headers({
    "Content-Type:application/json"
  })
  @POST("sandbox/payment/simulate")
  Call<SandboxPaymentSimulateResponse> sandboxPaymentSimulate(
    @retrofit2.http.Body SandboxPaymentSimulateRequest sandboxPaymentSimulateRequest
  );
   ...
   * @param transferOriginatorFundingAccountCreateRequest  (required)
   * @return Call&lt;TransferOriginatorFundingAccountCreateResponse&gt;
   * 
   * @see <a href="/api/products/transfer/platform-payments/#transferoriginatorfunding_accountcreate">Create a new funding account for an originator Documentation</a>
   */
  @Headers({
    "Content-Type:application/json"
  })
  @POST("transfer/originator/funding_account/create")
  Call<TransferOriginatorFundingAccountCreateResponse> transferOriginatorFundingAccountCreate(
    @retrofit2.http.Body TransferOriginatorFundingAccountCreateRequest transferOriginatorFundingAccountCreateRequest
  );
  ...
  @POST("user/get")
  Call<UserGetResponse> userGet(
    @retrofit2.http.Body UserGetRequest userGetRequest, @retrofit2.http.Header("Plaid-New-User-API-Enabled") Boolean plaidNewUserAPIEnabled
  );
  ...
  Call<UserUpdateResponse> userUpdate(
    @retrofit2.http.Body UserUpdateRequest userUpdateRequest, @retrofit2.http.Header("Plaid-New-User-API-Enabled") Boolean plaidNewUserAPIEnabled
  );
